...
onlist = genfromtxt('CM/ON1.bed',delimiter='\t',dtype=None)
downlist = genfromtxt('CM/RD1.bed',delimiter='\t',dtype=None)
offlist = genfromtxt('CM/OFF1.bed',delimiter='\t',dtype=None)
uplist = genfromtxt('CM/RU1.bed',delimiter='\t',dtype=None)
...
fil=sorted(glob.glob('/mnt/scratch/gurdon/cap76/DeepXen/Mouse/ChIP/BWCM/*.tab'))
...
model.save('/mnt/scratch/gurdon/cap76/DeepXen/Mouse/ChIP/BWCM//Model_deeper.h5')
...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/Mouse/ChIP/BWCM/prediction_scores_deeper.csv')
...
pd.DataFrame(prediction, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/Mouse/ChIP/BWCM/prediction_deeper.csv')
