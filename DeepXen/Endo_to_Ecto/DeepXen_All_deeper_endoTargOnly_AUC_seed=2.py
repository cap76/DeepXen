...
model = load_model('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/Model_deeper_endoTargOnly_seed=2.h5')

plt.switch_backend('agg')
Scores = np.zeros((1,1))
Scores[0,0] = model.evaluate([Xchr[valset,:,:],Xexp[valset,:,:]], Yalt[valset,:], batch_size=32)[1]
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/PredictionScores_endoTargOnly_seed=2.csv')
...
np.save('ResultsEndoAll/fpr_kearst_endoTargOnly_seed=2.npy', fpr_keras)
np.save('ResultsEndoAll/tpr_kearst_endoTargOnly_seed=2.npy', tpr_keras)
np.save('ResultsEndoAll/pr_kearst_endoTargOnly_seed=2.npy', pr_keras)
np.save('ResultsEndoAll/re_kearst_endoTargOnly_seed=2.npy', re_keras)
...
np.save('ResultsEndoAll/tpr_kears0_1_endoTargOnly_seed=2.npy', tpr_keras0_1)
np.save('ResultsEndoAll/tpr_kears0_2_endoTargOnly_seed=2.npy', tpr_keras0_2)
np.save('ResultsEndoAll/tpr_kears0_3_endoTargOnly_seed=2.npy', tpr_keras0_3)
np.save('ResultsEndoAll/tpr_kears0_4_endoTargOnly_seed=2.npy', tpr_keras0_4)
np.save('ResultsEndoAll/tpr_kears0_5_endoTargOnly_seed=2.npy', tpr_keras0_5)

np.save('ResultsEndoAll/fpr_kears0_1_endoTargOnly_seed=2.npy', fpr_keras0_1)
np.save('ResultsEndoAll/fpr_kears0_2_endoTargOnly_seed=2.npy', fpr_keras0_2)
np.save('ResultsEndoAll/fpr_kears0_3_endoTargOnly_seed=2.npy', fpr_keras0_3)
np.save('ResultsEndoAll/fpr_kears0_4_endoTargOnly_seed=2.npy', fpr_keras0_4)
np.save('ResultsEndoAll/fpr_kears0_5_endoTargOnly_seed=2.npy', fpr_keras0_5)
...
np.save('ResultsEndoAll/re_kears0_1_endoTargOnly_seed=2.npy', re_keras0_1)
np.save('ResultsEndoAll/re_kears0_2_endoTargOnly_seed=2.npy', re_keras0_2)
np.save('ResultsEndoAll/re_kears0_3_endoTargOnly_seed=2.npy', re_keras0_3)
np.save('ResultsEndoAll/re_kears0_4_endoTargOnly_seed=2.npy', re_keras0_4)
np.save('ResultsEndoAll/re_kears0_5_endoTargOnly_seed=2.npy', re_keras0_5)

np.save('ResultsEndoAll/pr_kears0_1_endoTargOnly_seed=2.npy', pr_keras0_1)
np.save('ResultsEndoAll/pr_kears0_2_endoTargOnly_seed=2.npy', pr_keras0_2)
np.save('ResultsEndoAll/pr_kears0_3_endoTargOnly_seed=2.npy', pr_keras0_3)
np.save('ResultsEndoAll/pr_kears0_4_endoTargOnly_seed=2.npy', pr_keras0_4)
np.save('ResultsEndoAll/pr_kears0_5_endoTargOnly_seed=2.npy', pr_keras0_5)
...
plt.savefig('ResultsEndoAll/PR_endoTargOnly_s2.pdf')
plt.draw()
plt.figure()
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('ResultsEndoAll/AUC_endoTargOnly_s2.pdf')
plt.draw()
...
M[0,24]= sum(OtherP)
M[0,25]= sum(OtherT)
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/Counts_endoTargOnly_seed=2.csv')
