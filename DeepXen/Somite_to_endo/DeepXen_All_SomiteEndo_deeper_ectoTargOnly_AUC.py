...
model = load_model('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Model_deeper_ectoTargOnly.h5')
...
np.save('ResultsSomiteEndoAll/tpr_kears0_1_somendoTargOnly.npy', tpr_keras0_1)
np.save('ResultsSomiteEndoAll/tpr_kears0_2_somendoTargOnly.npy', tpr_keras0_2)
np.save('ResultsSomiteEndoAll/tpr_kears0_3_somendoTargOnly.npy', tpr_keras0_3)
np.save('ResultsSomiteEndoAll/tpr_kears0_4_somendoTargOnly.npy', tpr_keras0_4)
np.save('ResultsSomiteEndoAll/tpr_kears0_5_somendoTargOnly.npy', tpr_keras0_5)
np.save('ResultsSomiteEndoAll/fpr_kears0_1_somendoTargOnly.npy', fpr_keras0_1)
np.save('ResultsSomiteEndoAll/fpr_kears0_2_somendoTargOnly.npy', fpr_keras0_2)
np.save('ResultsSomiteEndoAll/fpr_kears0_3_somendoTargOnly.npy', fpr_keras0_3)
np.save('ResultsSomiteEndoAll/fpr_kears0_4_somendoTargOnly.npy', fpr_keras0_4)
np.save('ResultsSomiteEndoAll/fpr_kears0_5_somendoTargOnly.npy', fpr_keras0_5)
...
np.save('ResultsSomiteEndoAll/pr_kears0_1_somendoTargOnly.npy', pr_keras0_1)
np.save('ResultsSomiteEndoAll/pr_kears0_2_somendoTargOnly.npy', pr_keras0_2)
np.save('ResultsSomiteEndoAll/pr_kears0_3_somendoTargOnly.npy', pr_keras0_3)
np.save('ResultsSomiteEndoAll/pr_kears0_4_somendoTargOnly.npy', pr_keras0_4)
np.save('ResultsSomiteEndoAll/pr_kears0_5_somendoTargOnly.npy', pr_keras0_5)

np.save('ResultsSomiteEndoAll/re_kears0_1_somendoTargOnly.npy', re_keras0_1)
np.save('ResultsSomiteEndoAll/re_kears0_2_somendoTargOnly.npy', re_keras0_2)
np.save('ResultsSomiteEndoAll/re_kears0_3_somendoTargOnly.npy', re_keras0_3)
np.save('ResultsSomiteEndoAll/re_kears0_4_somendoTargOnly.npy', re_keras0_4)
np.save('ResultsSomiteEndoAll/re_kears0_5_somendoTargOnly.npy', re_keras0_5)
...
np.save('ResultsSomiteEndoAll/rfpreds1_somendoTargOnly.npy',rfpred)
...
np.save('ResultsSomiteEndoAll/rf_fpr_kearss1_somendoTargOnly.npy', fpr_keras)
np.save('ResultsSomiteEndoAll/rf_tpr_kearss1_somendoTargOnly.npy', tpr_keras)
np.save('ResultsSomiteEndoAll/rf_pr_kearss1som_endoTargOnly.npy', pr_keras)
np.save('ResultsSomiteEndoAll/rf_re_kearss1_somendoTargOnly.npy', re_keras)
...
rfpred = clf.predict_proba(C1)
np.save('ResultsSomiteEndoAll/rf_preds2_somendoTargOnly.npy',rfpred)
fpr_keras, tpr_keras, thresholds_kerast = roc_curve(Yalt[valset,:].ravel(), rfpred.ravel())
pr_keras, re_keras, thresholds_keras = precision_recall_curve(Yalt[valset,:].ravel(), rfpred.ravel())
np.save('ResultsSomiteEndoAll/rf_fpr_kearss2_somendoTargOnly.npy', fpr_keras)
np.save('ResultsSomiteEndoAll/rf_tpr_kearss2_somendoTargOnly.npy', tpr_keras)
np.save('ResultsSomiteEndoAll/rf_pr_kearss2_somendoTargOnly.npy', pr_keras)
np.save('ResultsSomiteEndoAll/rf_re_kearss2_somendoTargOnly.npy', re_keras)
...
np.save('ResultsSomiteEndoAll/rf_tpr_kears0_1_somendoTargOnly.npy', tpr_keras0_1)
np.save('ResultsSomiteEndoAll/rf_tpr_kears0_2_somendoTargOnly.npy', tpr_keras0_2)
np.save('ResultsSomiteEndoAll/rf_tpr_kears0_3_somendoTargOnly.npy', tpr_keras0_3)
np.save('ResultsSomiteEndoAll/rf_tpr_kears0_4_somendoTargOnly.npy', tpr_keras0_4)
np.save('ResultsSomiteEndoAll/rf_tpr_kears0_5_somendoTargOnly.npy', tpr_keras0_5)
np.save('ResultsSomiteEndoAll/rf_tpr_kears1_1_somendoTargOnly.npy', tpr_keras1_1)
np.save('ResultsSomiteEndoAll/rf_tpr_kears1_2_somendoTargOnly.npy', tpr_keras1_2)
np.save('ResultsSomiteEndoAll/rf_tpr_kears1_3_somendoTargOnly.npy', tpr_keras1_3)
np.save('ResultsSomiteEndoAll/rf_tpr_kears1_4_somendoTargOnly.npy', tpr_keras1_4)
np.save('ResultsSomiteEndoAll/rf_tpr_kears1_5_somendoTargOnly.npy', tpr_keras1_5)
np.save('ResultsSomiteEndoAll/rf_fpr_kears0_1_somendoTargOnly.npy', fpr_keras0_1)
np.save('ResultsSomiteEndoAll/rf_fpr_kears0_2_somendoTargOnly.npy', fpr_keras0_2)
np.save('ResultsSomiteEndoAll/rf_fpr_kears0_3_somendoTargOnly.npy', fpr_keras0_3)
np.save('ResultsSomiteEndoAll/rf_fpr_kears0_4_somendoTargOnly.npy', fpr_keras0_4)
np.save('ResultsSomiteEndoAll/rf_fpr_kears0_5_somendoTargOnly.npy', fpr_keras0_5)
np.save('ResultsSomiteEndoAll/rf_fpr_kears1_1_somendoTargOnly.npy', fpr_keras1_1)
np.save('ResultsSomiteEndoAll/rf_fpr_kears1_2_somendoTargOnly.npy', fpr_keras1_2)
np.save('ResultsSomiteEndoAll/rf_fpr_kears1_3_somendoTargOnly.npy', fpr_keras1_3)
np.save('ResultsSomiteEndoAll/rf_fpr_kears1_4_somendoTargOnly.npy', fpr_keras1_4)
np.save('ResultsSomiteEndoAll/rf_fpr_kears1_5_somendoTargOnly.npy', fpr_keras1_5)
pr_keras0_1, re_keras0_1, thresholds_kerast = precision_recall_curve(Y0[:,[True,False,False,False,False]], P0[:,[True,False,False,False,False]])
pr_keras0_2, re_keras0_2, thresholds_kerast = precision_recall_curve(Y0[:,[False,True,False,False,False]], P0[:,[False,True,False,False,False]])
pr_keras0_3, re_keras0_3, thresholds_kerast = precision_recall_curve(Y0[:,[False,False,True,False,False]], P0[:,[False,False,True,False,False]])
pr_keras0_4, re_keras0_4, thresholds_kerast = precision_recall_curve(Y0[:,[False,False,False,True,False]], P0[:,[False,False,False,True,False]])
...
np.save('ResultsSomiteEndoAll/rf_pr_kears0_1_somendoTargOnly.npy', pr_keras0_1)
np.save('ResultsSomiteEndoAll/rf_pr_kears0_2_somendoTargOnly.npy', pr_keras0_2)
np.save('ResultsSomiteEndoAll/rf_pr_kears0_3_somendoTargOnly.npy', pr_keras0_3)
np.save('ResultsSomiteEndoAll/rf_pr_kears0_4_somendoTargOnly.npy', pr_keras0_4)
np.save('ResultsSomiteEndoAll/rf_pr_kears0_5_somendoTargOnly.npy', pr_keras0_5)
np.save('ResultsSomiteEndoAll/rf_pr_kears1_1_somendoTargOnly.npy', pr_keras1_1)
np.save('ResultsSomiteEndoAll/rf_pr_kears1_2_somendoTargOnly.npy', pr_keras1_2)
np.save('ResultsSomiteEndoAll/rf_pr_kears1_3_somendoTargOnly.npy', pr_keras1_3)
np.save('ResultsSomiteEndoAll/rf_pr_kears1_4_somendoTargOnly.npy', pr_keras1_4)
np.save('ResultsSomiteEndoAll/rf_pr_kears1_5_somendoTargOnly.npy', pr_keras1_5)
np.save('ResultsSomiteEndoAll/rf_re_kears0_1_somendoTargOnly.npy', re_keras0_1)
np.save('ResultsSomiteEndoAll/rf_re_kears0_2_somendoTargOnly.npy', re_keras0_2)
np.save('ResultsSomiteEndoAll/rf_re_kears0_3_somendoTargOnly.npy', re_keras0_3)
np.save('ResultsSomiteEndoAll/rf_re_kears0_4_somendoTargOnly.npy', re_keras0_4)
np.save('ResultsSomiteEndoAll/rf_re_kears0_5_somendoTargOnly.npy', re_keras0_5)
np.save('ResultsSomiteEndoAll/rf_re_kears1_1_somendoTargOnly.npy', re_keras1_1)
np.save('ResultsSomiteEndoAll/rf_re_kears1_2_somendoTargOnly.npy', re_keras1_2)
np.save('ResultsSomiteEndoAll/rf_re_kears1_3_somendoTargOnly.npy', re_keras1_3)
np.save('ResultsSomiteEndoAll/rf_re_kears1_4_somendoTargOnly.npy', re_keras1_4)
np.save('ResultsSomiteEndoAll/rf_re_kears1_5_somendoTargOnly.npy', re_keras1_5)
np.save('ResultsSomiteEndoAll/rfpred_somendoTargOnly.npy',rfpred)
np.save('ResultsSomiteEndoAll/rfpredTP_somendoTargOnly.npy',Yalt[testset,:])

#model = load_model('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Model_deeper_ectoOnly.h5')
plt.switch_backend('agg')
Scores = np.zeros((1,1))
Scores[0,0] = model.evaluate([Xchr[valset,:,:],Xexp[valset,:,:]], Yalt[valset,:], batch_size=32)[1]
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/PredictionScores_ectoTargOnly.csv')
classpred1 = model.predict([Xchr,Xexp], batch_size=1000)
import matplotlib.pyplot as plt
from matplotlib import colors as mcolors
plt.switch_backend('agg')
...
fpr_kerast, tpr_kerast, thresholds_kerast = roc_curve(Yalt[valset,:].ravel(), model.predict([Xchr[valset,:,:],Xexp[valset,:,:]], batch_size=1000).ravel())
pr_kerast, re_kerast, thresholds_keras = precision_recall_curve(Yalt[valset,:].ravel(), model.predict([Xchr[valset,:,:],Xexp[valset,:,:]], batch_size=1000).ravel())
np.save('ResultsSomiteEndoAll/fpr_kearst_ectoTargOnly.npy', fpr_keras)
np.save('ResultsSomiteEndoAll/tpr_kearst_ectoTargOnly.npy', tpr_keras)
np.save('ResultsSomiteEndoAll/pr_kearst_ectoTargOnly.npy', pr_keras)
np.save('ResultsSomiteEndoAll/re_kearst_ectoTargOnly.npy', re_keras)
plt.figure()
plt.plot(re_kerast, pr_kerast, label='Combined') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('ResultsSomiteEndoAll/PR_ectoTargOnly.pdf')
plt.draw()
plt.figure()
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('ResultsSomiteEndoAll/AUC_ectoTargOnly.pdf')
plt.draw()
...
M[0,24]= sum(OtherP)
M[0,25]= sum(OtherT)
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Counts_ectoTargOnly.csv')
