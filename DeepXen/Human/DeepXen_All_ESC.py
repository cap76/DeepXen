...
Output2 = genfromtxt('BWESC/EndoNT_On_all.inde.bed',delimiter='\t',dtype=None)

#Load in the list of genes
onlist = genfromtxt('RNAseq/ON_HDF_IVF_NT_ESC.csv',delimiter='\t',dtype=None)
downlist = genfromtxt('RNAseq/RD_HDF_IVF_NT_ESC.csv',delimiter='\t',dtype=None)
offlist = genfromtxt('RNAseq/OFF_HDF_IVF_NT_ESC.csv',delimiter='\t',dtype=None)
uplist = genfromtxt('RNAseq/RU_HDF_IVF_NT_ESC.csv',delimiter='\t',dtype=None)
complist = genfromtxt('ESC/ComplementarySetGenes.txt',delimiter='\t',dtype=None)
...
model.save('/mnt/scratch/gurdon/cap76/DeepXen/Human/BWESC/Model_deeper.h5')
...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/Human/BWESC/prediction_scores_deeper.csv')
