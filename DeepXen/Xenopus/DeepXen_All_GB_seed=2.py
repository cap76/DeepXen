...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/prediction_scores.csv')

model.save('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/Model_seed=2.h5')
...
pd.DataFrame(XP, columns=fil).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/prediction_settozero_seed=2.csv')
...
pd.DataFrame(prediction, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/predictionGB.csv')
...
pd.DataFrame(ScoresSomEct, columns=['Accuracy']).to_csv('ResultsEndoAllGB/prediction_SomEct_scores.csv')
...
prediction = np.concatenate((df1, df2, df3, df4, df5, df6, df7, df8, df9, df10, df11, df12, df13, df14, df15, df16, df14b),1)
pd.DataFrame(prediction, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('ResultsEndoAllGB/prediction_SomEcto.csv')
