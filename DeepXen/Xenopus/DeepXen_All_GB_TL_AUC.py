...
model1 = load_model('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/Model_TL_seed=2.h5')
...
np.save('ResultsEndoAllGB/fpr_kears_TL_seed=2.npy', fpr_keras)
np.save('ResultsEndoAllGB/fpr_kears1_TL_seed=2.npy', fpr_keras1)
np.save('ResultsEndoAllGB/tpr_kears_TL_seed=2.npy', tpr_keras)
np.save('ResultsEndoAllGB/tpr_kears1_TL_seed=2.npy', tpr_keras1)
np.save('ResultsEndoAllGB/pr_kears_TL_seed=2.npy', pr_keras)
np.save('ResultsEndoAllGB/pr_kears1_TL_seed=2.npy', pr_keras1)
np.save('ResultsEndoAllGB/re_kears_TL_seed=2.npy', re_keras)
np.save('ResultsEndoAllGB/re_kears1_TL_seed=2.npy', re_keras1)
...
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/Count_TLs_seed=2.csv')
