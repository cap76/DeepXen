...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAllGB/prediction_scores.csv')

model.save('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAllGB/Model.h5')
...
pd.DataFrame(XP, columns=fil).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAllGB/prediction_settozero.csv')
