...
Output2 = genfromtxt('Endoderm/allpeaks_labelled_cum_final.se.bed',delimiter='\t',dtype=None)


#Load in the list of genes
onlist = genfromtxt('Endoderm/OnMemFDRtGenes.txt',delimiter='\t',dtype=None)
downlist = genfromtxt('Endoderm/ReprogrammedDowntGenes.txt',delimiter='\t',dtype=None)
offlist = genfromtxt('Endoderm/OffMemFDRtGenes.txt',delimiter='\t',dtype=None)
uplist = genfromtxt('Endoderm/ReprogrammedUptGenes.txt',delimiter='\t',dtype=None)
complist = genfromtxt('Endoderm/ComplementarySettGenes.txt',delimiter='\t',dtype=None)
#foxlist = genfromtxt('Endoderm/FOXA1ChIP.txt',delimiter='\t',dtype=None)
#enhlist = genfromtxt('Endoderm/enhancers.bed',delimiter='\t',dtype=None)
...
explist = genfromtxt('../TSS/Endoderm/edger_de_pairing_BIGtable_endoIVF_ectoDonor_endoNT_plus_DE.p.csv',delimiter='\t',dtype=None)
explist1 = genfromtxt('../TSS/Endoderm/edger_de_pairing_BIGtable_endoIVF_ectoDonor_endoNT_plus_DE.rmnan.csv',delimiter='\t',dtype=None)
...
fil=sorted(glob.glob('Endoderm/*.tab'))
...
model = load_model('Endoderm/Model_deeper.h5') #predictions = model.predict([Xchr,Xexp], batch_size=1000)
model2 = load_model('Endoderm/Model_deeper_neg.h5') #predictions = model.predict([Xchr,Xexp], batch_size=1000)
model3 = load_model('Endoderm/Model_deeper_pos.h5') #predictions = model.predict([Xchr,Xexp], batch_size=1000)
...
fpr_keras1, tpr_keras1, thresholds_keras = roc_curve(Yalt.ravel(), model2.predict([Xexp], batch_size=1000).ravel())
pr_keras1, re_keras1, thresholds_keras = precision_recall_curve(Yalt.ravel(), model2.predict([Xexp], batch_size=1000).ravel())
...
plt.figure()
plt.plot(re_keras, pr_keras, label='Combined') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
...
plt.figure()
plt.plot(fpr_keras, tpr_keras, label='Combined') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
...
with DeepExplain(session=K.get_session()) as de:
    ...
    fModel = Model(inputs=input_tensors, outputs = model.layers[-2].output)
    target_tensor = fModel(input_tensors)
    attributions6 = de.explain('grad*input', target_tensor*np.array([0, 0., 0., 1., 0.]), input_tensors, [xs1_3,xs2_3])
    attributions6B = de.explain('grad*input', target_tensor*np.array([0, 0., 1., 0., 0.]), input_tensors, [xs1_3,xs2_3])

with DeepExplain(session=K.get_session()) as de:
    input_tensors = model.inputs #layers[0].input
    fModel = Model(inputs=input_tensors, outputs = model.layers[-2].output)
    target_tensor = fModel(input_tensors)
    attributions7 = de.explain('grad*input', target_tensor*np.array([0, 1., 0., 0., 0.]), input_tensors, [xs1_4,xs2_4])
    attributions7B = de.explain('grad*input', target_tensor*np.array([1, 0., 0., 0., 0.]), input_tensors, [xs1_4,xs2_4])
...
kmeans3 = KMeans(n_clusters=5, random_state=0).fit(np.reshape(attributions6[0],(np.shape(attributions6[0])[0],np.shape(attributions6[0])[1]*np.shape(attributions6[0])[2])))
kmeans3.labels_

hm13 = np.mean(attributions6[0],axis=0)
hm14 = np.mean(attributions6[0][kmeans3.labels_==0,:,:],axis=0)
hm15 = np.mean(attributions6[0][kmeans3.labels_==1,:,:],axis=0)
hm16 = np.mean(attributions6[0][kmeans3.labels_==2,:,:],axis=0)
hm17 = np.mean(attributions6[0][kmeans3.labels_==3,:,:],axis=0)
hm18 = np.mean(attributions6[0][kmeans3.labels_==4,:,:],axis=0)


kmeans4 = KMeans(n_clusters=5, random_state=0).fit(np.reshape(attributions7[0],(np.shape(attributions7[0])[0],np.shape(attributions7[0])[1]*np.shape(attributions7[0])[2])))
kmeans4.labels_

hm19 = np.mean(attributions7[0],axis=0)
hm20 = np.mean(attributions7[0][kmeans4.labels_==0,:,:],axis=0)
hm21 = np.mean(attributions7[0][kmeans4.labels_==1,:,:],axis=0)
hm22 = np.mean(attributions7[0][kmeans4.labels_==2,:,:],axis=0)
hm23 = np.mean(attributions7[0][kmeans4.labels_==3,:,:],axis=0)
hm24 = np.mean(attributions7[0][kmeans4.labels_==4,:,:],axis=0)
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_ac_cl5.pdf')
plt.close()
...
#    target_tensor = fModel(input_tensors)
#    attributions6 = de.explain('grad*input', target_tensor*np.array([0, 0., 0., 0., 1.]), input_tensors, [xs1_1,xs2_1])
#
#GN=Output2['f3'][uinds]
#GN1 = GN[OnT]
#
#for i in range(0,100):
#       filename = "Test2_%s_On_%d.pdf" % (i,1)
#       plt.figure()
#       plt.subplot(3, 1, 1)
#       plt.imshow(np.transpose(attributions1[0][i]), interpolation='nearest')
#       plt.yticks(np.arange(22), labs, fontsize=2,  rotation=20)
#       plt.clim(-0.01,0.005)
#       plt.clim(-0.01,0.005)
#       plt.subplot(2, 1, 2)
#       plt.imshow(np.transpose(attributions3[0][i]), interpolation='nearest')
#       plt.yticks(np.arange(22), labs, fontsize=2,  rotation=20)
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('Endo/SomEndo_OnTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('Endo/SomEndo_OffTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('Endo/SomEndo_OnOffT.pdf')
plt.draw()
plt.close()
...
#CCstp = np.zeros((count+1,100))
#CCsfp = np.zeros((count+1,100))
#CCstn = np.zeros((count+1,100))
#CCsfn = np.zeros((count+1,100))

#CCsotp = np.zeros((count+1,100))
#CCsofp = np.zeros((count+1,100))
#CCsotn = np.zeros((count+1,100))
#CCsofn = np.zeros((count+1,100))
...
#      count = count+1
#      for i in range(0, 100):
#         CCstp[count,i] = np.corrcoef( np.transpose(Xchr1[OnTP,i,k]), np.transpose(Xchr1[OnTP,i,j]) )[0,1]
#         CCsfp[count,i] = np.corrcoef( np.transpose(Xchr1[OnFP,i,k]), np.transpose(Xchr1[OnFP,i,j]) )[0,1]
#         CCstn[count,i] = np.corrcoef( np.transpose(Xchr1[OnTN,i,k]), np.transpose(Xchr1[OnTN,i,j]) )[0,1]
#         CCsfn[count,i] = np.corrcoef( np.transpose(Xchr1[OnFN,i,k]), np.transpose(Xchr1[OnFN,i,j]) )[0,1]
#         CCsotp[count,i] = np.corrcoef( np.transpose(Xchr1[OffTP,i,k]), np.transpose(Xchr1[OffTP,i,j]) )[0,1]
#         CCsofp[count,i] = np.corrcoef( np.transpose(Xchr1[OffFP,i,k]), np.transpose(Xchr1[OffFP,i,j]) )[0,1]
#         CCsotn[count,i] = np.corrcoef( np.transpose(Xchr1[OffTN,i,k]), np.transpose(Xchr1[OffTN,i,j]) )[0,1]
#         CCsofn[count,i] = np.corrcoef( np.transpose(Xchr1[OffFN,i,k]), np.transpose(Xchr1[OffFN,i,j]) )[0,1]
#      bb1=str(fil[k]).replace("SomiteEndo/","")
#      cc1=bb1.replace(".merged.sorted.bam_vs_Input_CPM.bw.tab","")
#      dd1=cc1.replace(".singleRep.bam_vs_Input_CPM.bw.tab","")
#      ee1=dd1.replace(".bw.tab","")
#      bb2=str(fil[j]).replace("SomiteEndo/","")
#      cc2=bb2.replace(".merged.sorted.bam_vs_Input_CPM.bw.tab","")
#      dd2=cc2.replace(".singleRep.bam_vs_Input_CPM.bw.tab","")
#      ee2=dd2.replace(".bw.tab","")
#      filename = ee1+"_"+ee2+"_v2"+"somendo"+".pdf"
#      a = [np.transpose(CCstp[count,:]),np.transpose(CCstn[count,:]),np.transpose(CCsotp[count,:]),np.transpose(CCsotn[count,:])]
#      ax = seaborn.swarmplot(data=a)
#      ax.set(xticklabels=names)
#      #plt.savefig('meh')
#      #plt.plot(np.linspace(0, 1, num=100),CCstp[count,:], 'b-', label='OnTP')
#      #plt.plot(np.linspace(0, 1, num=100),CCstn[count,:], 'b--', label='OnTN')
#      #plt.plot(np.linspace(0, 1, num=100),CCsotp[count,:], 'r-', label='OffTP')
#      #plt.plot(np.linspace(0, 1, num=100),CCsotn[count,:], 'r--', label='OffTN')
#      #plt.legend(loc='best')
...
kmeans1 = KMeans(n_clusters=5, random_state=0).fit(
...
np.reshape(attributions6[0],(np.shape(attributions6[0])[0],np.shape(attributions6[0])[1]*np.shape(attributions6[0])[2]))- np.reshape(attributions6B[0],(np.shape(attributions6B[0])[0],np.shape(attributions6B[0])[1]*np.shape(attributions6B[0])[2])) )
kmeans3.labels_

hm13 = np.mean(attributions6[0]-attributions6B[0],axis=0)
hm14 = np.mean(attributions6[0][kmeans3.labels_==0,:,:]-attributions6B[0][kmeans3.labels_==0,:,:],axis=0)
hm15 = np.mean(attributions6[0][kmeans3.labels_==1,:,:]-attributions6B[0][kmeans3.labels_==1,:,:],axis=0)
hm16 = np.mean(attributions6[0][kmeans3.labels_==2,:,:]-attributions6B[0][kmeans3.labels_==2,:,:],axis=0)
hm17 = np.mean(attributions6[0][kmeans3.labels_==3,:,:]-attributions6B[0][kmeans3.labels_==3,:,:],axis=0)
hm18 = np.mean(attributions6[0][kmeans3.labels_==4,:,:]-attributions6B[0][kmeans3.labels_==4,:,:],axis=0)


kmeans4 = KMeans(n_clusters=5, random_state=0).fit(
np.reshape(attributions7[0],(np.shape(attributions7[0])[0],np.shape(attributions7[0])[1]*np.shape(attributions7[0])[2]))-np.reshape(attributions7B[0],(np.shape(attributions7B[0])[0],np.shape(attributions7B[0])[1]*np.shape(attributions7B[0])[2])) )
kmeans4.labels_

hm19 = np.mean(attributions7[0]-attributions7B[0],axis=0)
hm20 = np.mean(attributions7[0][kmeans4.labels_==0,:,:]-attributions7B[0][kmeans4.labels_==0,:,:],axis=0)
hm21 = np.mean(attributions7[0][kmeans4.labels_==1,:,:]-attributions7B[0][kmeans4.labels_==1,:,:],axis=0)
hm22 = np.mean(attributions7[0][kmeans4.labels_==2,:,:]-attributions7B[0][kmeans4.labels_==2,:,:],axis=0)
hm23 = np.mean(attributions7[0][kmeans4.labels_==3,:,:]-attributions7B[0][kmeans4.labels_==3,:,:],axis=0)
hm24 = np.mean(attributions7[0][kmeans4.labels_==4,:,:]-attributions7B[0][kmeans4.labels_==4,:,:],axis=0)
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OnTP_Deltaac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_Deltaac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_Deltaac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_Deltaac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_Deltaac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/ONTP_Deltaac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_Deltaac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_Deltaac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_Deltaac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_Deltaac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_Deltaac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/OffTP_Deltaac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_Deltaac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_Deltaac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_Deltaac_cl2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_Deltaac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_Deltaac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RUTP_Deltaac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_Deltaac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_Deltaac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_Deltaac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_Deltaac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_Deltaac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('Endo/RDTP_Deltaac_cl5.pdf')
plt.close()
