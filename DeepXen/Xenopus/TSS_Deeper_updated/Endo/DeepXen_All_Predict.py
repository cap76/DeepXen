...
model1 = load_model('Model_deeper_neg.h5') #predictions = model.predict([Xchr,Xexp], batch_size=1000)
model2 = load_model('Model_deeper_pos.h5') #predictions = model.predict([Xchr,Xexp], batch_size=1000)
...
fpr_keras1, tpr_keras1, thresholds_keras = roc_curve(Yalt.ravel(), model1.predict([Xchr], batch_size=1000).ravel())
fpr_keras2, tpr_keras2, thresholds_keras = roc_curve(Yalt.ravel(), model2.predict([Xexp], batch_size=1000).ravel())

pr_keras, re_keras, thresholds_keras = precision_recall_curve(Yalt.ravel(), model.predict([Xchr,Xexp], batch_size=1000).ravel())
pr_keras1, re_keras1, thresholds_keras = precision_recall_curve(Yalt.ravel(), model1.predict([Xchr], batch_size=1000).ravel())
pr_keras2, re_keras2, thresholds_keras = precision_recall_curve(Yalt.ravel(), model2.predict([Xexp], batch_size=1000).ravel())

np.save('re_keras.npy', re_keras)
np.save('re_keras1.npy', re_keras1)
np.save('re_keras2.npy', re_keras2)

np.save('pr_keras.npy', pr_keras)
np.save('pr_keras1.npy', pr_keras1)
np.save('pr_keras2.npy', pr_keras2)

np.save('fpr_keras.npy', fpr_keras)
np.save('fpr_keras1.npy', fpr_keras1)
np.save('fpr_keras2.npy', fpr_keras2)

np.save('tpr_keras.npy', tpr_keras)
np.save('tpr_keras1.npy', tpr_keras1)
np.save('tpr_keras2.npy', tpr_keras2)

#testset Xchr[trainset,:,:],Xexp

plt.figure()
plt.plot(re_keras, pr_keras, label='Endo') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
plt.plot(re_keras1, pr_keras1, label='Endo (chr)') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
plt.plot(re_keras2, pr_keras2, label='Endo (exp)') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
#plt.xlim([0.0, 1.0])
#plt.ylim([0.0, 1.05])
plt.xlabel('Recall')
...
plt.savefig('EndoPR.pdf')
plt.draw()

plt.figure()
plt.plot(fpr_keras, tpr_keras, label='Endo') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
plt.plot(fpr_keras1, tpr_keras1, label='Endo (chr)') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
plt.plot(fpr_keras2, tpr_keras2, label='Endo (exp)') #, label='ROC curve (area = %0.2f)' % roc_auc[i])
plt.plot([0, 1], [0, 1], 'k--')
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('EndoAUC.pdf')
plt.draw()

fpr_keras, tpr_keras, thresholds_keras = roc_curve(Yalt.ravel(), model.predict([Xchr[valset,:,:],Xexp[valset,:,:]], batch_size=1000).ravel())
fpr_keras1, tpr_keras1, thresholds_keras = roc_curve(Yalt.ravel(), model1.predict([Xchr[valset,:,:]], batch_size=1000).ravel())
fpr_keras2, tpr_keras2, thresholds_keras = roc_curve(Yalt.ravel(), model2.predict([Xexp[valset,:,:]], batch_size=1000).ravel())

pr_keras, re_keras, thresholds_keras = precision_recall_curve(Yalt.ravel(), model.predict([Xchr[valset,:,:],Xexp[valset,:,:]], batch_size=1000).ravel())
pr_keras1, re_keras1, thresholds_keras = precision_recall_curve(Yalt.ravel(), model1.predict([Xchr[valset,:,:]], batch_size=1000).ravel())
pr_keras2, re_keras2, thresholds_keras = precision_recall_curve(Yalt.ravel(), model2.predict([Xexp[valset,:,:]], batch_size=1000).ravel())

np.save('re_keras_evalset.npy', re_keras)
np.save('re_keras1_evalset.npy', re_keras1)
np.save('re_keras2_evalset.npy', re_keras2)

np.save('pr_keras_evalset.npy', pr_keras)
np.save('pr_keras1_evalset.npy', pr_keras1)
np.save('pr_keras2_evalset.npy', pr_keras2)

np.save('fpr_keras_evalset.npy', fpr_keras)
np.save('fpr_keras1_evalset.npy', fpr_keras1)
np.save('fpr_keras2_evalset.npy', fpr_keras2)

np.save('tpr_keras_evalset.npy', tpr_keras)
np.save('tpr_keras1_evalset.npy', tpr_keras1)
np.save('tpr_keras2_evalset.npy', tpr_keras2)
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('EndoPR_evalset.pdf')
plt.draw()
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('EndoAUC_evalset.pdf')
plt.draw()
...
plt.xlim((-4,8))
plt.ylim((-1,140))
plt.savefig('Endo_OnTPFP_chronly_1.pdf')
plt.draw()
plt.close()
...
plt.xlim((-4,8))
plt.ylim((-1,140))
plt.savefig('Endo_OffTPFP_chronly_1.pdf')
plt.draw()
plt.close()
...
plt.xlim((-4,8))
plt.ylim((-1,140))
plt.savefig('Endo_OnOffT_1.pdf')
plt.draw()
plt.close()



classpred = model2.predict([Xexp], batch_size=1000)
...
plt.xlim((-4,8))
plt.ylim((-1,140))
plt.savefig('Endo_OnTPFP_chronly_2.pdf')
plt.draw()
plt.close()
...
plt.xlim((-4,8))
plt.ylim((-1,140))
plt.savefig('Endo_OffTPFP_chronly_2.pdf')
plt.draw()
plt.close()
...
plt.xlim((-4,8))
plt.ylim((-1,140))
plt.savefig('Endo_OnTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-4,8))
plt.ylim((-1,140))
plt.savefig('Endo_OffTPFP_chronly.pdf')
plt.draw()
plt.close()
...
#plt.colorbar()
plt.savefig('EndoFullChr/OnTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/ONTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/ONTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/ONTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/ONTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/ONTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/OffTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/OffTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/OffTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/OffTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/OffTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/OffTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RUTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RUTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RUTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RUTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RUTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RUTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RDTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RDTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RDTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RDTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RDTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFullChr/RDTP_ac_cl5.pdf')
plt.close()
...
kmeans4 = KMeans(n_clusters=5, random_state=0).fit(
                                                   np.reshape(attributions5[0],(np.shape(attributions5[0])[0],np.shape(attributions5[0])[1]*np.shape(attributions5[0])[2]))-np.reshape(attributions5B[0],(np.shape(attributions7B[0])[0],np.shape(attributions5B[0])[1]*np.shape(attributions5B[0])[2])) )
kmeans4.labels_
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/OnTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/ONTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/ONTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/ONTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/ONTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/ONTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/OffTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/OffTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/OffTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/OffTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/OffTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RUTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RUTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RUTP_Deltac_cl2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RUTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RUTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RUTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RDTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RDTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RDTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RDTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RDTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoChrHM/RDTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/OnTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/ONTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/ONTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/ONTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/ONTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/ONTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/OffTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/OffTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/OffTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/OffTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/OffTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/OffTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RUTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RUTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RUTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RUTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RUTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RUTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RDTP_ac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RDTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RDTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RDTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RDTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoFull/RDTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/OnTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/ONTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/ONTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/ONTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/ONTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/ONTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/OffTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/OffTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/OffTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/OffTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/OffTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/OffTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RUTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RUTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RUTP_Deltac_cl2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RUTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RUTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RUTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RDTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RDTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RDTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RDTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RDTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.003,0.001)
#plt.colorbar()
plt.savefig('EndoHM/RDTP_Deltac_cl5.pdf')
plt.close()
...
OnP = ((classpred1[:,0]>np.max(classpred[:,1:5],axis=1)))
#OnP = ((classpred:,0]>np.max(classpred[:,1:5],axis=1)))
OnT = (Yalt[:,0]==1)
OnTP = ((classpred[:,0]>np.max(classpred[:,1:5],axis=1)) & (Yalt[:,0]==1))
OnFP = ((classpred[:,0]>np.max(classpred[:,1:5],axis=1)) & (Yalt[:,0]==0))
