...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/PredictionScores.csv')
...
np.save('ResultsSomiteEndoAll/tpr_kears0_1.npy', tpr_keras0_1)
np.save('ResultsSomiteEndoAll/tpr_kears0_2.npy', tpr_keras0_2)
np.save('ResultsSomiteEndoAll/tpr_kears0_3.npy', tpr_keras0_3)
np.save('ResultsSomiteEndoAll/tpr_kears0_4.npy', tpr_keras0_4)
np.save('ResultsSomiteEndoAll/tpr_kears0_5.npy', tpr_keras0_5)
np.save('ResultsSomiteEndoAll/tpr_kears1_1.npy', tpr_keras1_1)
np.save('ResultsSomiteEndoAll/tpr_kears1_2.npy', tpr_keras1_2)
np.save('ResultsSomiteEndoAll/tpr_kears1_3.npy', tpr_keras1_3)
np.save('ResultsSomiteEndoAll/tpr_kears1_4.npy', tpr_keras1_4)
np.save('ResultsSomiteEndoAll/tpr_kears1_5.npy', tpr_keras1_5)
np.save('ResultsSomiteEndoAll/tpr_kears2_1.npy', tpr_keras2_1)
np.save('ResultsSomiteEndoAll/tpr_kears2_2.npy', tpr_keras2_2)
np.save('ResultsSomiteEndoAll/tpr_kears2_3.npy', tpr_keras2_3)
np.save('ResultsSomiteEndoAll/tpr_kears2_4.npy', tpr_keras2_4)
np.save('ResultsSomiteEndoAll/tpr_kears2_5.npy', tpr_keras2_5)
np.save('ResultsSomiteEndoAll/tpr_kears4_1.npy', tpr_keras4_1)
np.save('ResultsSomiteEndoAll/tpr_kears4_2.npy', tpr_keras4_2)
np.save('ResultsSomiteEndoAll/tpr_kears4_3.npy', tpr_keras4_3)
np.save('ResultsSomiteEndoAll/tpr_kears4_4.npy', tpr_keras4_4)
np.save('ResultsSomiteEndoAll/tpr_kears4_5.npy', tpr_keras4_5)
np.save('ResultsSomiteEndoAll/tpr_kears5_1.npy', tpr_keras5_1)
np.save('ResultsSomiteEndoAll/tpr_kears5_2.npy', tpr_keras5_2)
np.save('ResultsSomiteEndoAll/tpr_kears5_3.npy', tpr_keras5_3)
np.save('ResultsSomiteEndoAll/tpr_kears5_4.npy', tpr_keras5_4)
np.save('ResultsSomiteEndoAll/tpr_kears5_5.npy', tpr_keras5_5)
np.save('ResultsSomiteEndoAll/tpr_kears6_1.npy', tpr_keras6_1)
np.save('ResultsSomiteEndoAll/tpr_kears6_2.npy', tpr_keras6_2)
np.save('ResultsSomiteEndoAll/tpr_kears6_3.npy', tpr_keras6_3)
np.save('ResultsSomiteEndoAll/tpr_kears6_4.npy', tpr_keras6_4)
np.save('ResultsSomiteEndoAll/tpr_kears6_5.npy', tpr_keras6_5)

np.save('ResultsSomiteEndoAll/fpr_kears0_1.npy', fpr_keras0_1)
np.save('ResultsSomiteEndoAll/fpr_kears0_2.npy', fpr_keras0_2)
np.save('ResultsSomiteEndoAll/fpr_kears0_3.npy', fpr_keras0_3)
np.save('ResultsSomiteEndoAll/fpr_kears0_4.npy', fpr_keras0_4)
np.save('ResultsSomiteEndoAll/fpr_kears0_5.npy', fpr_keras0_5)
np.save('ResultsSomiteEndoAll/fpr_kears1_1.npy', fpr_keras1_1)
np.save('ResultsSomiteEndoAll/fpr_kears1_2.npy', fpr_keras1_2)
np.save('ResultsSomiteEndoAll/fpr_kears1_3.npy', fpr_keras1_3)
np.save('ResultsSomiteEndoAll/fpr_kears1_4.npy', fpr_keras1_4)
np.save('ResultsSomiteEndoAll/fpr_kears1_5.npy', fpr_keras1_5)
np.save('ResultsSomiteEndoAll/fpr_kears2_1.npy', fpr_keras2_1)
np.save('ResultsSomiteEndoAll/fpr_kears2_2.npy', fpr_keras2_2)
np.save('ResultsSomiteEndoAll/fpr_kears2_3.npy', fpr_keras2_3)
np.save('ResultsSomiteEndoAll/fpr_kears2_4.npy', fpr_keras2_4)
np.save('ResultsSomiteEndoAll/fpr_kears2_5.npy', fpr_keras2_5)
np.save('ResultsSomiteEndoAll/fpr_kears4_1.npy', fpr_keras4_1)
np.save('ResultsSomiteEndoAll/fpr_kears4_2.npy', fpr_keras4_2)
np.save('ResultsSomiteEndoAll/fpr_kears4_3.npy', fpr_keras4_3)
np.save('ResultsSomiteEndoAll/fpr_kears4_4.npy', fpr_keras4_4)
np.save('ResultsSomiteEndoAll/fpr_kears4_5.npy', fpr_keras4_5)
np.save('ResultsSomiteEndoAll/fpr_kears5_1.npy', fpr_keras5_1)
np.save('ResultsSomiteEndoAll/fpr_kears5_2.npy', fpr_keras5_2)
np.save('ResultsSomiteEndoAll/fpr_kears5_3.npy', fpr_keras5_3)
np.save('ResultsSomiteEndoAll/fpr_kears5_4.npy', fpr_keras5_4)
np.save('ResultsSomiteEndoAll/fpr_kears5_5.npy', fpr_keras5_5)
np.save('ResultsSomiteEndoAll/fpr_kears6_1.npy', fpr_keras6_1)
np.save('ResultsSomiteEndoAll/fpr_kears6_2.npy', fpr_keras6_2)
np.save('ResultsSomiteEndoAll/fpr_kears6_3.npy', fpr_keras6_3)
np.save('ResultsSomiteEndoAll/fpr_kears6_4.npy', fpr_keras6_4)
np.save('ResultsSomiteEndoAll/fpr_kears6_5.npy', fpr_keras6_5)
...
np.save('ResultsSomiteEndoAll/pr_kears0_1.npy', pr_keras0_1)
np.save('ResultsSomiteEndoAll/pr_kears0_2.npy', pr_keras0_2)
np.save('ResultsSomiteEndoAll/pr_kears0_3.npy', pr_keras0_3)
np.save('ResultsSomiteEndoAll/pr_kears0_4.npy', pr_keras0_4)
np.save('ResultsSomiteEndoAll/pr_kears0_5.npy', pr_keras0_5)
np.save('ResultsSomiteEndoAll/pr_kears1_1.npy', pr_keras1_1)
np.save('ResultsSomiteEndoAll/pr_kears1_2.npy', pr_keras1_2)
np.save('ResultsSomiteEndoAll/pr_kears1_3.npy', pr_keras1_3)
np.save('ResultsSomiteEndoAll/pr_kears1_4.npy', pr_keras1_4)
np.save('ResultsSomiteEndoAll/pr_kears1_5.npy', pr_keras1_5)
np.save('ResultsSomiteEndoAll/pr_kears2_1.npy', pr_keras2_1)
np.save('ResultsSomiteEndoAll/pr_kears2_2.npy', pr_keras2_2)
np.save('ResultsSomiteEndoAll/pr_kears2_3.npy', pr_keras2_3)
np.save('ResultsSomiteEndoAll/pr_kears2_4.npy', pr_keras2_4)
np.save('ResultsSomiteEndoAll/pr_kears2_5.npy', pr_keras2_5)
np.save('ResultsSomiteEndoAll/pr_kears4_1.npy', pr_keras4_1)
np.save('ResultsSomiteEndoAll/pr_kears4_2.npy', pr_keras4_2)
np.save('ResultsSomiteEndoAll/pr_kears4_3.npy', pr_keras4_3)
np.save('ResultsSomiteEndoAll/pr_kears4_4.npy', pr_keras4_4)
np.save('ResultsSomiteEndoAll/pr_kears4_5.npy', pr_keras4_5)
np.save('ResultsSomiteEndoAll/pr_kears5_1.npy', pr_keras5_1)
np.save('ResultsSomiteEndoAll/pr_kears5_2.npy', pr_keras5_2)
np.save('ResultsSomiteEndoAll/pr_kears5_3.npy', pr_keras5_3)
np.save('ResultsSomiteEndoAll/pr_kears5_4.npy', pr_keras5_4)
np.save('ResultsSomiteEndoAll/pr_kears5_5.npy', pr_keras5_5)
np.save('ResultsSomiteEndoAll/pr_kears6_1.npy', pr_keras6_1)
np.save('ResultsSomiteEndoAll/pr_kears6_2.npy', pr_keras6_2)
np.save('ResultsSomiteEndoAll/pr_kears6_3.npy', pr_keras6_3)
np.save('ResultsSomiteEndoAll/pr_kears6_4.npy', pr_keras6_4)
np.save('ResultsSomiteEndoAll/pr_kears6_5.npy', pr_keras6_5)

np.save('ResultsSomiteEndoAll/re_kears0_1.npy', re_keras0_1)
np.save('ResultsSomiteEndoAll/re_kears0_2.npy', re_keras0_2)
np.save('ResultsSomiteEndoAll/re_kears0_3.npy', re_keras0_3)
np.save('ResultsSomiteEndoAll/re_kears0_4.npy', re_keras0_4)
np.save('ResultsSomiteEndoAll/re_kears0_5.npy', re_keras0_5)
np.save('ResultsSomiteEndoAll/re_kears1_1.npy', re_keras1_1)
np.save('ResultsSomiteEndoAll/re_kears1_2.npy', re_keras1_2)
np.save('ResultsSomiteEndoAll/re_kears1_3.npy', re_keras1_3)
np.save('ResultsSomiteEndoAll/re_kears1_4.npy', re_keras1_4)
np.save('ResultsSomiteEndoAll/re_kears1_5.npy', re_keras1_5)
np.save('ResultsSomiteEndoAll/re_kears2_1.npy', re_keras2_1)
np.save('ResultsSomiteEndoAll/re_kears2_2.npy', re_keras2_2)
np.save('ResultsSomiteEndoAll/re_kears2_3.npy', re_keras2_3)
np.save('ResultsSomiteEndoAll/re_kears2_4.npy', re_keras2_4)
np.save('ResultsSomiteEndoAll/re_kears2_5.npy', re_keras2_5)
np.save('ResultsSomiteEndoAll/re_kears4_1.npy', re_keras4_1)
np.save('ResultsSomiteEndoAll/re_kears4_2.npy', re_keras4_2)
np.save('ResultsSomiteEndoAll/re_kears4_3.npy', re_keras4_3)
np.save('ResultsSomiteEndoAll/re_kears4_4.npy', re_keras4_4)
np.save('ResultsSomiteEndoAll/re_kears4_5.npy', re_keras4_5)
np.save('ResultsSomiteEndoAll/re_kears5_1.npy', re_keras5_1)
np.save('ResultsSomiteEndoAll/re_kears5_2.npy', re_keras5_2)
np.save('ResultsSomiteEndoAll/re_kears5_3.npy', re_keras5_3)
np.save('ResultsSomiteEndoAll/re_kears5_4.npy', re_keras5_4)
np.save('ResultsSomiteEndoAll/re_kears5_5.npy', re_keras5_5)
np.save('ResultsSomiteEndoAll/re_kears6_1.npy', re_keras6_1)
np.save('ResultsSomiteEndoAll/re_kears6_2.npy', re_keras6_2)
np.save('ResultsSomiteEndoAll/re_kears6_3.npy', re_keras6_3)
np.save('ResultsSomiteEndoAll/re_kears6_4.npy', re_keras6_4)
np.save('ResultsSomiteEndoAll/re_kears6_5.npy', re_keras6_5)
...
pd.DataFrame(prediction1, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Pred1.csv')
pd.DataFrame(prediction2, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Pred2Neg.csv')
pd.DataFrame(prediction3, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Pred3Pos.csv')
pd.DataFrame(prediction4, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Pred4.csv')
pd.DataFrame(prediction5, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Pred5Neg.csv')
pd.DataFrame(prediction6, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Pred6Pos.csv')
...
np.save('ResultsSomiteEndoAll/fpr_kearst.npy', fpr_keras)
np.save('ResultsSomiteEndoAll/fpr_kears1.npy', fpr_keras1)
np.save('ResultsSomiteEndoAll/fpr_kears2.npy', fpr_keras2)
np.save('ResultsSomiteEndoAll/fpr_kears4.npy', fpr_kerast4)
np.save('ResultsSomiteEndoAll/fpr_kears5.npy', fpr_keras5)
np.save('ResultsSomiteEndoAll/fpr_kears6.npy', fpr_keras6)

np.save('ResultsSomiteEndoAll/tpr_kearst.npy', tpr_keras)
np.save('ResultsSomiteEndoAll/tpr_kears1.npy', tpr_keras1)
np.save('ResultsSomiteEndoAll/tpr_kears2.npy', tpr_keras2)
np.save('ResultsSomiteEndoAll/tpr_kears4.npy', tpr_kerast4)
np.save('ResultsSomiteEndoAll/tpr_kears5.npy', tpr_keras5)
np.save('ResultsSomiteEndoAll/tpr_kears6.npy', tpr_keras6)

np.save('ResultsSomiteEndoAll/pr_kearst.npy', pr_keras)
np.save('ResultsSomiteEndoAll/pr_kears1.npy', pr_keras1)
np.save('ResultsSomiteEndoAll/pr_kears2.npy', pr_keras2)
np.save('ResultsSomiteEndoAll/pr_kears4.npy', pr_kerast4)
np.save('ResultsSomiteEndoAll/pr_kears5.npy', pr_keras5)
np.save('ResultsSomiteEndoAll/pr_kears6.npy', pr_keras6)

np.save('ResultsSomiteEndoAll/re_kearst.npy', re_keras)
np.save('ResultsSomiteEndoAll/re_kears1.npy', re_keras1)
np.save('ResultsSomiteEndoAll/re_kears2.npy', re_keras2)
np.save('ResultsSomiteEndoAll/re_kears4.npy', re_kerast4)
np.save('ResultsSomiteEndoAll/re_kears5.npy', re_keras5)
np.save('ResultsSomiteEndoAll/re_kears6.npy', re_keras6)
...
plt.savefig('ResultsSomiteEndoAll/PR.pdf')
plt.draw()
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('ResultsSomiteEndoAll/AUC.pdf')
plt.draw()
...
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/Counts.csv')
