...
model.save('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/Model_deeper.h5')
...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/prediction_scores_deeper.csv')
