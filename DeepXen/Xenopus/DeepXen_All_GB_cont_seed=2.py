...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/prediction_scores_cont_seed=2.csv')

model.save('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/Model_cont_seed=2.h5')
...
pd.DataFrame(prediction, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/predictionGB_cont-seed=2.csv')
