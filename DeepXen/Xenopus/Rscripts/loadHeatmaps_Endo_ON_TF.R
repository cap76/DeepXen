...
mat2 <- np$load("EndoFull/On_attributions_OnTP_perm.npy")s
...
colnames(Msp) <- labs
pheatmap(t(Msp),color =  redblue1(20),  gaps_row=c(10,20), border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster"),filename = paste("RDClminusPerm", i, ".pdf", sep="") )
