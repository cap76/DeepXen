...
mat <- np$load("TargOnly/Endo/Down_attributions_OnTP_endoTargOnly.npy")
mat1 <- np$load("TargOnly/Endo/On_attributions_OnTP_endoTargOnly.npy")
mat2 <- np$load("TargOnly/Endo/On_attributions_OnTP_endoTargOnly_shuffle.npy")

#mat1 <- np$load("EndoFull/Down_attributions_OnTP_1.npy")


#Index for TP ON memory genes (to get get IDS etc)
onTP <- np$load("TargOnly/Endo/OnTP_endoTargOnly.npy")
...
labs<-c("Endo_H2A.ub","Endo_H2A.x.3","Endo_H3K27ac","Endo_H3K27me3","Endo_H3K36me3","Endo_H3K4me1","Endo_H3K4me2","Endo_H3K4me3","Endo_H3K79me3","Endo_H3K9me3","GC.bw.tab","Methylation")
...
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"), filename = "ON_targ.pdf")
...
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"), filename = "ONTF_targ.pdf")

mean2 = apply(mat, c(1,3), sum) / dim(mat)[2]
mean3 = apply(mat, c(2,3), sum) / dim(mat)[1]
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"), filename = "RD.pdf")
...
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"), filename = "RDTF.pdf")


mean2 = apply(mat1-mat, c(1,3), sum) / dim(mat)[2]
mean3 = apply(mat1-mat, c(2,3), sum) / dim(mat)[1]
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"),  filename = "ONmiusRD.pdf")

mean2 = apply(mat1-mat2, c(1,3), sum) / dim(mat)[2]
mean3 = apply(mat1-mat2, c(2,3), sum) / dim(mat)[1]
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"),  filename = "ONminusPerm.pdf")
...
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"),  filename = "ONmiusRDTF.pdf")
...
colnames(mean3) <- labs
pheatmap(t(mean3),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE,cluster_cols=FALSE, main = c("Average over all genes"),  filename = "ONminusPermTF.pdf")
...
pheatmap(t(SummaryMat),color =  redblue1(20), gaps_col = c(NCl,NCl*2),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "ONRDPCl.pdf")

colnames(SummaryMat1) <- labs
rownames(SummaryMat1) <- paste("Cl",rep(1:NCl, each=1))
pheatmap(t(SummaryMat1),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "ONCl.pdf")
...
Msp <- uniqueMat1[i,,]
colnames(Msp) <- labs
pheatmap(t(Msp),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster"),filename = paste("ONCl", i, ".pdf", sep="") )

Msp <- uniqueMat2[i,,]
colnames(Msp) <- labs
pheatmap(t(Msp),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster"),filename = paste("RDCl", i, ".pdf", sep="") )

Msp <- uniqueMat1[i,,]-uniqueMat2[i,,]
colnames(Msp) <- labs
pheatmap(t(Msp),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster"),filename = paste("ONClminusRD", i, ".pdf", sep="") )

Msp <- uniqueMat1[i,,]-uniqueMat3[i,,]
colnames(Msp) <- labs
pheatmap(t(Msp),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster"),filename = paste("RDClminusPerm", i, ".pdf", sep="") )
...
colnames(Msp) <- labs
pheatmap(t(Msp),color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster"))


saveRDS(Msp,file = "Savedfilename.rds")
ReadinMatrix <- readRDS(file = "Savedfilename.rds")
