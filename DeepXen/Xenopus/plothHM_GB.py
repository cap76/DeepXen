...
Output2 = genfromtxt('/mnt/scratch/gurdon/cap76/DeepXen/BW_Endo_All_GB/allpeaks_labelled_cum_final.s.bed',delimiter='\t',dtype=None)

#Load in the list of genes
onlist = genfromtxt('ChIP_Endo_GB/OnMemFDRtGenes.txt',delimiter='\t',dtype=None)
downlist = genfromtxt('ChIP_Endo_GB/ReprogrammedDowntGenes.txt',delimiter='\t',dtype=None)
offlist = genfromtxt('ChIP_Endo_GB/OffMemFDRtGenes.txt',delimiter='\t',dtype=None)
uplist = genfromtxt('ChIP_Endo_GB/ReprogrammedUptGenes.txt',delimiter='\t',dtype=None)
complist = genfromtxt('ChIP_Endo_GB/ComplementarySettGenes.txt',delimiter='\t',dtype=None)
...
Xrawexp = np.zeros((np.shape(Output2)[0],1,7))
...
model = load_model('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAllGB/Model1.h5')
...
np.save('EndoFullGB/OnTP_seed=2.npy', OnTP)
np.save('EndoFullGB/OnFP_seed=2.npy', OnFP)
np.save('EndoFullGB/OnTN_seed=2.npy', OnTN)
np.save('EndoFullGB/OnFN_seed=2.npy', OnFN)
np.save('EndoFullGB/OffTP_seed=2.npy', OffTP)
np.save('EndoFullGB/OffFP_seed=2.npy', OffFP)
np.save('EndoFullGB/OffTN_seed=2.npy', OffTN)
np.save('EndoFullGB/OffFN_seed=2.npy', OffFN)
np.save('EndoFullGB/RUTP_seed=2.npy', RUTP)
np.save('EndoFullGB/RUFP_seed=2.npy', RUFP)
np.save('EndoFullGB/RUTN_seed=2.npy', RUTN)
np.save('EndoFullGB/RUFN_seed=2.npy', RUFN)
np.save('EndoFullGB/RDTP_seed=2.npy', RDTP)
np.save('EndoFullGB/RDFP_seed=2.npy', RDFP)
np.save('EndoFullGB/RDTN_seed=2.npy', RDTN)
np.save('EndoFullGB/RDFN_seed=2.npy', RDFN)
...
np.save('EndoFullGB/On_attributions_OnTP.npy', attributions4[0])
np.save('EndoFullGB/Down_attributions_OnTP.npy', attributions4B[0])
np.save('EndoFullGB/Off_attributions_OffTP.npy', attributions5[0])
np.save('EndoFullGB/Up_attributions_OffTP.npy', attributions5B[0])

np.save('EndoFullGB/On_attributions_OnTP_1.npy', attributions4[1])
np.save('EndoFullGB/Down_attributions_OnTP_1.npy', attributions4B[1])
np.save('EndoFullGB/Off_attributions_OffTP_1.npy', attributions5[1])
np.save('EndoFullGB/Up_attributions_OffTP_1.npy', attributions5B[1])
...
np.save('EndoFullGB/Up_attributions_RUTP.npy', attributions4[0])
np.save('EndoFullGB/Off_attributions_RUTP.npy', attributions4B[0])
np.save('EndoFullGB/Down_attributions_RDTP.npy', attributions5[0])
np.save('EndoFullGB/On_attributions_RDTP.npy', attributions5B[0])



np.save('EndoFullGB/Up_attributions_RUTP_1.npy', attributions4[1])
np.save('EndoFullGB/Off_attributions_RUTP_1.npy', attributions4B[1])
np.save('EndoFullGB/Down_attributions_RDTP_1.npy', attributions5[1])
np.save('EndoFullGB/On_attributions_RDTP_1.npy', attributions5B[1])
...
plt.colorbar()
plt.savefig('EndoFullGB/OnTP_ac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl2_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl5_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl2_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl5_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl2_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl5_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl2_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl5_seed=2.pdf')
plt.close()

np.save('EndoFullGB/hm1_seed=2.npy', hm1)
np.save('EndoFullGB/hm2_seed=2.npy', hm2)
np.save('EndoFullGB/hm3_seed=2.npy', hm3)
np.save('EndoFullGB/hm4_seed=2.npy', hm4)
np.save('EndoFullGB/hm5_seed=2.npy', hm5)
np.save('EndoFullGB/hm6_seed=2.npy', hm6)
np.save('EndoFullGB/hm7_seed=2.npy', hm7)
np.save('EndoFullGB/hm8_seed=2.npy', hm8)
np.save('EndoFullGB/hm9_seed=2.npy', hm9)
np.save('EndoFullGB/hm10_seed=2.npy', hm10)
np.save('EndoFullGB/hm11_seed=2.npy', hm11)
np.save('EndoFullGB/hm12_seed=2.npy', hm12)
np.save('EndoFullGB/hm13_seed=2.npy', hm13)
np.save('EndoFullGB/hm14_seed=2.npy', hm14)
np.save('EndoFullGB/hm15_seed=2.npy', hm15)
np.save('EndoFullGB/hm16_seed=2.npy', hm16)
np.save('EndoFullGB/hm17_seed=2.npy', hm17)
np.save('EndoFullGB/hm18_seed=2.npy', hm18)
np.save('EndoFullGB/hm19_seed=2.npy', hm19)
np.save('EndoFullGB/hm20_seed=2.npy', hm20)
np.save('EndoFullGB/hm21_seed=2.npy', hm21)
np.save('EndoFullGB/hm22_seed=2.npy', hm22)
np.save('EndoFullGB/hm23_seed=2.npy', hm23)
np.save('EndoFullGB/hm24_seed=2.npy', hm24)
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OnTP_Deltac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl2_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl5_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl2_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl5_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl2_seed=2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl5_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl1_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl2_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl3_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl4_seed=2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl5_seed=2.pdf')
plt.close()

np.save('EndoFullGB/hm1_delta_seed=2.npy', hm1)
np.save('EndoFullGB/hm2_delta.npy', hm2)
np.save('EndoFullGB/hm3_delta.npy', hm3)
np.save('EndoFullGB/hm4_delta.npy', hm4)
np.save('EndoFullGB/hm5_delta.npy', hm5)
np.save('EndoFullGB/hm6_delta.npy', hm6)
np.save('EndoFullGB/hm7_delta.npy', hm7)
np.save('EndoFullGB/hm8_delta.npy', hm8)
np.save('EndoFullGB/hm9_delta.npy', hm9)
np.save('EndoFullGB/hm10_delta.npy', hm10)
np.save('EndoFullGB/hm11_delta.npy', hm11)
np.save('EndoFullGB/hm12_delta.npy', hm12)
np.save('EndoFullGB/hm13_delta.npy', hm13)
np.save('EndoFullGB/hm14_delta.npy', hm14)
np.save('EndoFullGB/hm15_delta.npy', hm15)
np.save('EndoFullGB/hm16_delta.npy', hm16)
np.save('EndoFullGB/hm17_delta.npy', hm17)
np.save('EndoFullGB/hm18_delta.npy', hm18)
np.save('EndoFullGB/hm19_delta.npy', hm19)
np.save('EndoFullGB/hm20_delta.npy', hm20)
np.save('EndoFullGB/hm21_delta.npy', hm21)
np.save('EndoFullGB/hm22_delta.npy', hm22)
np.save('EndoFullGB/hm23_delta.npy', hm23)
np.save('EndoFullGB/hm24_delta.npy', hm24)
...
np.save('EndoChrGB/OnTP.npy', OnTP)
np.save('EndoChrGB/OnFP.npy', OnFP)
np.save('EndoChrGB/OnTN.npy', OnTN)
np.save('EndoChrGB/OnFN.npy', OnFN)
np.save('EndoChrGB/OffTP.npy', OffTP)
np.save('EndoChrGB/OffFP.npy', OffFP)
np.save('EndoChrGB/OffTN.npy', OffTN)
np.save('EndoChrGB/OffFN.npy', OffFN)
np.save('EndoChrGB/RUTP.npy', RUTP)
np.save('EndoChrGB/RUFP.npy', RUFP)
np.save('EndoChrGB/RUTN.npy', RUTN)
np.save('EndoChrGB/RUFN.npy', RUFN)
np.save('EndoChrGB/RDTP.npy', RDTP)
np.save('EndoChrGB/RDFP.npy', RDFP)
np.save('EndoChrGB/RDTN.npy', RDTN)
np.save('EndoChrGB/RDFN.npy', RDFN)
...
np.save('EndoChrGB/On_attributions_OnTP.npy', attributions4[0])
np.save('EndoChrGB/Down_attributions_OnTP.npy', attributions4B[0])
np.save('EndoChrGB/Off_attributions_OffTP.npy', attributions5[0])
np.save('EndoChrGB/Up_attributions_OffTP.npy', attributions5B[0])
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OnTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_ac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_ac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_ac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_ac_cl5.pdf')
plt.close()

np.save('EndoChrGB/hm1.npy', hm1)
np.save('EndoChrGB/hm2.npy', hm2)
np.save('EndoChrGB/hm3.npy', hm3)
np.save('EndoChrGB/hm4.npy', hm4)
np.save('EndoChrGB/hm5.npy', hm4)
np.save('EndoChrGB/hm6.npy', hm6)
np.save('EndoChrGB/hm7.npy', hm7)
np.save('EndoChrGB/hm8.npy', hm8)
np.save('EndoChrGB/hm9.npy', hm9)
np.save('EndoChrGB/hm10.npy', hm10)
np.save('EndoChrGB/hm11.npy', hm11)
np.save('EndoChrGB/hm12.npy', hm12)
np.save('EndoChrGB/hm13.npy', hm13)
np.save('EndoChrGB/hm14.npy', hm14)
np.save('EndoChrGB/hm15.npy', hm15)
np.save('EndoChrGB/hm16.npy', hm16)
np.save('EndoChrGB/hm17.npy', hm17)
np.save('EndoChrGB/hm18.npy', hm18)
np.save('EndoChrGB/hm19.npy', hm19)
np.save('EndoChrGB/hm20.npy', hm20)
np.save('EndoChrGB/hm21.npy', hm21)
np.save('EndoChrGB/hm22.npy', hm22)
np.save('EndoChrGB/hm23.npy', hm23)
np.save('EndoChrGB/hm24.npy', hm24)
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OnTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_Deltac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/ONTP_Deltac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_Deltac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/OffTP_Deltac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_Deltac_cl2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RUTP_Deltac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_Deltac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChrGB/RDTP_Deltac_cl5.pdf')
plt.close()



np.save('EndoChrGB/hm1_delta.npy', hm1)
np.save('EndoChrGB/hm2_delta.npy', hm2)
np.save('EndoChrGB/hm3_delta.npy', hm3)
np.save('EndoChrGB/hm4_delta.npy', hm4)
np.save('EndoChrGB/hm5_delta.npy', hm4)
np.save('EndoChrGB/hm6_delta.npy', hm6)
np.save('EndoChrGB/hm7_delta.npy', hm7)
np.save('EndoChrGB/hm8_delta.npy', hm8)
np.save('EndoChrGB/hm9_delta.npy', hm9)
np.save('EndoChrGB/hm10_delta.npy', hm10)
np.save('EndoChrGB/hm11_delta.npy', hm11)
np.save('EndoChrGB/hm12_delta.npy', hm12)
np.save('EndoChrGB/hm13_delta.npy', hm13)
np.save('EndoChrGB/hm14_delta.npy', hm14)
np.save('EndoChrGB/hm15_delta.npy', hm15)
np.save('EndoChrGB/hm16_delta.npy', hm16)
np.save('EndoChrGB/hm17_delta.npy', hm17)
np.save('EndoChrGB/hm18_delta.npy', hm18)
np.save('EndoChrGB/hm19_delta.npy', hm19)
np.save('EndoChrGB/hm20_delta.npy', hm20)
np.save('EndoChrGB/hm21_delta.npy', hm21)
np.save('EndoChrGB/hm22_delta.npy', hm22)
np.save('EndoChrGB/hm23_delta.npy', hm23)
np.save('EndoChrGB/hm24_delta.npy', hm24)
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoChrGB/SomEndo_OnTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoChrGB/SomEndo_OffTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoChrGB/SomEndo_OnOffT.pdf')
plt.draw()
plt.close()
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('EndoFullGB/AUC.pdf')
plt.draw()
