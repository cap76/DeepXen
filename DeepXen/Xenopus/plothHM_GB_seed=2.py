...
np.save('EndoFullGB/OnTP.npy', OnTP)
np.save('EndoFullGB/OnFP.npy', OnFP)
np.save('EndoFullGB/OnTN.npy', OnTN)
np.save('EndoFullGB/OnFN.npy', OnFN)
np.save('EndoFullGB/OffTP.npy', OffTP)
np.save('EndoFullGB/OffFP.npy', OffFP)
np.save('EndoFullGB/OffTN.npy', OffTN)
np.save('EndoFullGB/OffFN.npy', OffFN)
np.save('EndoFullGB/RUTP.npy', RUTP)
np.save('EndoFullGB/RUFP.npy', RUFP)
np.save('EndoFullGB/RUTN.npy', RUTN)
np.save('EndoFullGB/RUFN.npy', RUFN)
np.save('EndoFullGB/RDTP.npy', RDTP)
np.save('EndoFullGB/RDFP.npy', RDFP)
np.save('EndoFullGB/RDTN.npy', RDTN)
np.save('EndoFullGB/RDFN.npy', RDFN)
...
plt.colorbar()
plt.savefig('EndoFullGB/OnTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_ac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_ac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_ac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_ac_cl5.pdf')
plt.close()

np.save('EndoFullGB/hm1.npy', hm1)
np.save('EndoFullGB/hm2.npy', hm2)
np.save('EndoFullGB/hm3.npy', hm3)
np.save('EndoFullGB/hm4.npy', hm4)
np.save('EndoFullGB/hm5.npy', hm5)
np.save('EndoFullGB/hm6.npy', hm6)
np.save('EndoFullGB/hm7.npy', hm7)
np.save('EndoFullGB/hm8.npy', hm8)
np.save('EndoFullGB/hm9.npy', hm9)
np.save('EndoFullGB/hm10.npy', hm10)
np.save('EndoFullGB/hm11.npy', hm11)
np.save('EndoFullGB/hm12.npy', hm12)
np.save('EndoFullGB/hm13.npy', hm13)
np.save('EndoFullGB/hm14.npy', hm14)
np.save('EndoFullGB/hm15.npy', hm15)
np.save('EndoFullGB/hm16.npy', hm16)
np.save('EndoFullGB/hm17.npy', hm17)
np.save('EndoFullGB/hm18.npy', hm18)
np.save('EndoFullGB/hm19.npy', hm19)
np.save('EndoFullGB/hm20.npy', hm20)
np.save('EndoFullGB/hm21.npy', hm21)
np.save('EndoFullGB/hm22.npy', hm22)
np.save('EndoFullGB/hm23.npy', hm23)
np.save('EndoFullGB/hm24.npy', hm24)
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OnTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/ONTP_Deltac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/OffTP_Deltac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RUTP_Deltac_cl5.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl1.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl2.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl4.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoFullGB/RDTP_Deltac_cl5.pdf')
plt.close()

np.save('EndoFullGB/hm1_delta.npy', hm1)
