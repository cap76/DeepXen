...
np.save('EndoFullGB/OnTP_shuffle.npy', OnTP)
np.save('EndoFullGB/OffTP_shuffle.npy', OffTP)
np.save('EndoFullGB/RUTP_shuffle.npy', RUTP)
np.save('EndoFullGB/RDTP_shuffle.npy', RDTP)
...
np.save('EndoFullGB/On_attributions_OnTP_perm.npy', attributions4[0])
np.save('EndoFullGB/Down_attributions_OnTP_perm.npy', attributions4B[0])
np.save('EndoFullGB/Off_attributions_OffTP_perm.npy', attributions5[0])
np.save('EndoFullGB/Up_attributions_OffTP_perm.npy', attributions5B[0])

np.save('EndoFullGB/On_attributions_OnTP_1_perm.npy', attributions4[1])
np.save('EndoFullGB/Down_attributions_OnTP_1_perm.npy', attributions4B[1])
np.save('EndoFullGB/Off_attributions_OffTP_1_perm.npy', attributions5[1])
np.save('EndoFullGB/Up_attributions_OffTP_1_perm.npy', attributions5B[1])
...
np.save('EndoFullGB/Up_attributions_RUTP_perm.npy', attributions4[0])
np.save('EndoFullGB/Off_attributions_RUTP_perm.npy', attributions4B[0])
np.save('EndoFullGB/Down_attributions_RDTP_perm.npy', attributions5[0])
np.save('EndoFullGB/On_attributions_RDTP_perm.npy', attributions5B[0])


np.save('EndoFullGB/Up_attributions_RUTP_1_perm.npy', attributions4[1])
np.save('EndoFullGB/Off_attributions_RUTP_1_perm.npy', attributions4B[1])
np.save('EndoFullGB/Down_attributions_RDTP_1_perm.npy', attributions5[1])
np.save('EndoFullGB/On_attributions_RDTP_1_perm.npy', attributions5B[1])
...
#
#np.save('EndoFullGB/rfpred.npy',rfpred)
#np.save('EndoFullGB/rfpredTP.npy',Yalt[testset,:])
...
C1 = np.concatenate((A1,B1),axis=1)
rfpred = clf.predict_proba(C1)
np.save('EndoFullGB/rfpreds1.npy',rfpred)
...
np.save('EndoFullGB/rf_fpr_kearss1.npy', fpr_keras)
np.save('EndoFullGB/rf_tpr_kearss1.npy', tpr_keras)
np.save('EndoFullGB/rf_pr_kearss1.npy', pr_keras)
np.save('EndoFullGB/rf_re_kearss1.npy', re_keras)
...
C1 = np.concatenate((A1,B1),axis=1)
rfpred = clf.predict_proba(C1)
np.save('EndoFullGB/rfpreds2.npy',rfpred)
fpr_keras, tpr_keras, thresholds_kerast = roc_curve(Yalt[valset,:].ravel(), rfpred.ravel())
pr_keras, re_keras, thresholds_keras = precision_recall_curve(Yalt[valset,:].ravel(), rfpred.ravel())
np.save('EndoFullGB/rf_fpr_kearss2.npy', fpr_keras)
np.save('EndoFullGB/rf_tpr_kearss2.npy', tpr_keras)
np.save('EndoFullGB/rf_pr_kearss2.npy', pr_keras)
np.save('EndoFullGB/rf_re_kearss2.npy', re_keras)
P1 = rfpred
Y0 = Yalt[valset,:]
Y1 = Yalt[valset,:]
...
np.save('EndoFullGB/rf_tpr_kears0_1.npy', tpr_keras0_1)
np.save('EndoFullGB/rf_tpr_kears0_2.npy', tpr_keras0_2)
np.save('EndoFullGB/rf_tpr_kears0_3.npy', tpr_keras0_3)
np.save('EndoFullGB/rf_tpr_kears0_4.npy', tpr_keras0_4)
np.save('EndoFullGB/rf_tpr_kears0_5.npy', tpr_keras0_5)
np.save('EndoFullGB/rf_tpr_kears1_1.npy', tpr_keras1_1)
np.save('EndoFullGB/rf_tpr_kears1_2.npy', tpr_keras1_2)
np.save('EndoFullGB/rf_tpr_kears1_3.npy', tpr_keras1_3)
np.save('EndoFullGB/rf_tpr_kears1_4.npy', tpr_keras1_4)
np.save('EndoFullGB/rf_tpr_kears1_5.npy', tpr_keras1_5)
np.save('EndoFullGB/rf_fpr_kears0_1.npy', fpr_keras0_1)
np.save('EndoFullGB/rf_fpr_kears0_2.npy', fpr_keras0_2)
np.save('EndoFullGB/rf_fpr_kears0_3.npy', fpr_keras0_3)
np.save('EndoFullGB/rf_fpr_kears0_4.npy', fpr_keras0_4)
np.save('EndoFullGB/rf_fpr_kears0_5.npy', fpr_keras0_5)
np.save('EndoFullGB/rf_fpr_kears1_1.npy', fpr_keras1_1)
np.save('EndoFullGB/rf_fpr_kears1_2.npy', fpr_keras1_2)
np.save('EndoFullGB/rf_fpr_kears1_3.npy', fpr_keras1_3)
np.save('EndoFullGB/rf_fpr_kears1_4.npy', fpr_keras1_4)
np.save('EndoFullGB/rf_fpr_kears1_5.npy', fpr_keras1_5)
...
np.save('EndoFullGB/rf_pr_kears0_1.npy', pr_keras0_1)
np.save('EndoFullGB/rf_pr_kears0_2.npy', pr_keras0_2)
np.save('EndoFullGB/rf_pr_kears0_3.npy', pr_keras0_3)
np.save('EndoFullGB/rf_pr_kears0_4.npy', pr_keras0_4)
np.save('EndoFullGB/rf_pr_kears0_5.npy', pr_keras0_5)
np.save('EndoFullGB/rf_pr_kears1_1.npy', pr_keras1_1)
np.save('EndoFullGB/rf_pr_kears1_2.npy', pr_keras1_2)
np.save('EndoFullGB/rf_pr_kears1_3.npy', pr_keras1_3)
np.save('EndoFullGB/rf_pr_kears1_4.npy', pr_keras1_4)
np.save('EndoFullGB/rf_pr_kears1_5.npy', pr_keras1_5)

np.save('EndoFullGB/rf_re_kears0_1.npy', re_keras0_1)
np.save('EndoFullGB/rf_re_kears0_2.npy', re_keras0_2)
np.save('EndoFullGB/rf_re_kears0_3.npy', re_keras0_3)
np.save('EndoFullGB/rf_re_kears0_4.npy', re_keras0_4)
np.save('EndoFullGB/rf_re_kears0_5.npy', re_keras0_5)
np.save('EndoFullGB/rf_re_kears1_1.npy', re_keras1_1)
np.save('EndoFullGB/rf_re_kears1_2.npy', re_keras1_2)
np.save('EndoFullGB/rf_re_kears1_3.npy', re_keras1_3)
np.save('EndoFullGB/rf_re_kears1_4.npy', re_keras1_4)
np.save('EndoFullGB/rf_re_kears1_5.npy', re_keras1_5)
...
np.save('EndoFullGB/rfpreds1_neg.npy',rfpred)
fpr_keras, tpr_keras, thresholds_kerast = roc_curve(Yalt[valset,:].ravel(), rfpred.ravel())
pr_keras, re_keras, thresholds_keras = precision_recall_curve(Yalt[valset,:].ravel(), rfpred.ravel())
np.save('EndoFullGB/rf_fpr_kearss1_neg.npy', fpr_keras)
np.save('EndoFullGB/rf_tpr_kearss1_neg.npy', tpr_keras)
np.save('EndoFullGB/rf_pr_kearss1_neg.npy', pr_keras)
np.save('EndoFullGB/rf_re_kearss1_neg.npy', re_keras)
P0 = rfpred
clf = RandomForestClassifier(n_estimators=200, max_depth=2,random_state=1)
clf.fit(B , np.argmax(Yalt[trainset,:], axis=1) )
A1 =np.squeeze(np.reshape(Xchr[valset,:,:],(np.shape(Xchr[valset,:,:])[0],   np.shape(Xchr[valset,:,:])[1] *np.shape(Xchr[valset,:,:])[2])  ))
...
fpr_keras, tpr_keras, thresholds_kerast = roc_curve(Yalt[valset,:].ravel(), rfpred.ravel())
pr_keras, re_keras, thresholds_keras = precision_recall_curve(Yalt[valset,:].ravel(), rfpred.ravel())
np.save('EndoFullGB/rf_fpr_kearss2_neg.npy', fpr_keras)
np.save('EndoFullGB/rf_tpr_kearss2_neg.npy', tpr_keras)
np.save('EndoFullGB/rf_pr_kearss2_neg.npy', pr_keras)
np.save('EndoFullGB/rf_re_kearss2_neg.npy', re_keras)
P1 = rfpred
Y0 = Yalt[valset,:]
Y1 = Yalt[valset,:]
fpr_keras0_1, tpr_keras0_1, thresholds_kerast = roc_curve(Y0[:,[True,False,False,False,False]], P0[:,[True,False,False,False,False]])
...
fpr_keras1_4, tpr_keras1_4, thresholds_kerast = roc_curve(Y1[:,[False,False,False,True,False]], P1[:,[False,False,False,True,False]])
fpr_keras1_5, tpr_keras1_5, thresholds_kerast = roc_curve(Y1[:,[False,False,False,False,True]], P1[:,[False,False,False,False,True]])
np.save('EndoFullGB/rf_tpr_kears0_1_neg.npy', tpr_keras0_1)
np.save('EndoFullGB/rf_tpr_kears0_2_neg.npy', tpr_keras0_2)
np.save('EndoFullGB/rf_tpr_kears0_3_neg.npy', tpr_keras0_3)
np.save('EndoFullGB/rf_tpr_kears0_4_neg.npy', tpr_keras0_4)
np.save('EndoFullGB/rf_tpr_kears0_5_neg.npy', tpr_keras0_5)
np.save('EndoFullGB/rf_tpr_kears1_1_neg.npy', tpr_keras1_1)
np.save('EndoFullGB/rf_tpr_kears1_2_neg.npy', tpr_keras1_2)
np.save('EndoFullGB/rf_tpr_kears1_3_neg.npy', tpr_keras1_3)
np.save('EndoFullGB/rf_tpr_kears1_4_neg.npy', tpr_keras1_4)
np.save('EndoFullGB/rf_tpr_kears1_5_neg.npy', tpr_keras1_5)
np.save('EndoFullGB/rf_fpr_kears0_1_neg.npy', fpr_keras0_1)
np.save('EndoFullGB/rf_fpr_kears0_2_neg.npy', fpr_keras0_2)
np.save('EndoFullGB/rf_fpr_kears0_3_neg.npy', fpr_keras0_3)
np.save('EndoFullGB/rf_fpr_kears0_4_neg.npy', fpr_keras0_4)
np.save('EndoFullGB/rf_fpr_kears0_5_neg.npy', fpr_keras0_5)
np.save('EndoFullGB/rf_fpr_kears1_1_neg.npy', fpr_keras1_1)
np.save('EndoFullGB/rf_fpr_kears1_2_neg.npy', fpr_keras1_2)
np.save('EndoFullGB/rf_fpr_kears1_3_neg.npy', fpr_keras1_3)
np.save('EndoFullGB/rf_fpr_kears1_4_neg.npy', fpr_keras1_4)
np.save('EndoFullGB/rf_fpr_kears1_5_neg.npy', fpr_keras1_5)
pr_keras0_1, re_keras0_1, thresholds_kerast = precision_recall_curve(Y0[:,[True,False,False,False,False]], P0[:,[True,False,False,False,False]])
pr_keras0_2, re_keras0_2, thresholds_kerast = precision_recall_curve(Y0[:,[False,True,False,False,False]], P0[:,[False,True,False,False,False]])
pr_keras0_3, re_keras0_3, thresholds_kerast = precision_recall_curve(Y0[:,[False,False,True,False,False]], P0[:,[False,False,True,False,False]])
pr_keras0_4, re_keras0_4, thresholds_kerast = precision_recall_curve(Y0[:,[False,False,False,True,False]], P0[:,[False,False,False,True,False]])
...
pr_keras1_4, re_keras1_4, thresholds_kerast = precision_recall_curve(Y1[:,[False,False,False,True,False]], P1[:,[False,False,False,True,False]])
pr_keras1_5, re_keras1_5, thresholds_kerast = precision_recall_curve(Y1[:,[False,False,False,False,True]], P1[:,[False,False,False,False,True]])
np.save('EndoFullGB/rf_pr_kears0_1_neg.npy', pr_keras0_1)
np.save('EndoFullGB/rf_pr_kears0_2_neg.npy', pr_keras0_2)
np.save('EndoFullGB/rf_pr_kears0_3_neg.npy', pr_keras0_3)
np.save('EndoFullGB/rf_pr_kears0_4_neg.npy', pr_keras0_4)
np.save('EndoFullGB/rf_pr_kears0_5_neg.npy', pr_keras0_5)
np.save('EndoFullGB/rf_pr_kears1_1_neg.npy', pr_keras1_1)
np.save('EndoFullGB/rf_pr_kears1_2_neg.npy', pr_keras1_2)
np.save('EndoFullGB/rf_pr_kears1_3_neg.npy', pr_keras1_3)
np.save('EndoFullGB/rf_pr_kears1_4_neg.npy', pr_keras1_4)
np.save('EndoFullGB/rf_pr_kears1_5_neg.npy', pr_keras1_5)
np.save('EndoFullGB/rf_re_kears0_1_neg.npy', re_keras0_1)
np.save('EndoFullGB/rf_re_kears0_2_neg.npy', re_keras0_2)
np.save('EndoFullGB/rf_re_kears0_3_neg.npy', re_keras0_3)
np.save('EndoFullGB/rf_re_kears0_4_neg.npy', re_keras0_4)
np.save('EndoFullGB/rf_re_kears0_5_neg.npy', re_keras0_5)
np.save('EndoFullGB/rf_re_kears1_1_neg.npy', re_keras1_1)
np.save('EndoFullGB/rf_re_kears1_2_neg.npy', re_keras1_2)
np.save('EndoFullGB/rf_re_kears1_3_neg.npy', re_keras1_3)
np.save('EndoFullGB/rf_re_kears1_4_neg.npy', re_keras1_4)
np.save('EndoFullGB/rf_re_kears1_5_neg.npy', re_keras1_5)
...
np.save('EndoChrGB/Down_attributions_RUTP.npy', attributions4[0])
np.save('EndoChrGB/On_attributions_RUTP.npy', attributions4B[0])
np.save('EndoChrGB/Up_attributions_RDTP.npy', attributions5[0])
np.save('EndoChrGB/Off_attributions_RDTP.npy', attributions5B[0])
...
np.save('EndoChrGB/OnTP_shuffle.npy', OnTP)
np.save('EndoChrGB/OffTP_shuffle.npy', OffTP)
np.save('EndoChrGB/RUTP_shuffle.npy', RUTP)
np.save('EndoChrGB/RDTP_shuffle.npy', RDTP)
...
np.save('EndoChrGB/On_attributions_OnTP_perm.npy', attributions4[0])
np.save('EndoChrGB/Down_attributions_OnTP_perm.npy', attributions4B[0])
np.save('EndoChrGB/Off_attributions_OffTP_perm.npy', attributions5[0])
np.save('EndoChrGB/Up_attributions_OffTP_perm.npy', attributions5B[0])
...
np.save('EndoChrGB/Up_attributions_RUTP_perm.npy', attributions4[0])
np.save('EndoChrGB/Off_attributions_RUTP_perm.npy', attributions4B[0])
np.save('EndoChrGB/Down_attributions_RDTP_perm.npy', attributions5[0])
np.save('EndoChrGB/On_attributions_RDTP_perm.npy', attributions5B[0])
...
#np.save('EndoChrSomEndo/rfpred.npy',rfpred)
np.save('EndoChrGB/rfpred.npy',rfpred)
np.save('EndoChrGB/rfpredTP.npy',Yalt[testset,:])
