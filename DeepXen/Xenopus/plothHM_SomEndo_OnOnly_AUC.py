...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/PredictionScores_ONONLY.csv')
...
pd.DataFrame(prediction1, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OnOnlyPred1.csv')
pd.DataFrame(prediction2, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OnOnlyPred2Neg.csv')
pd.DataFrame(prediction3, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OnOnlyPred3Pos.csv')
pd.DataFrame(prediction4, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OnOnlyPred4.csv')
pd.DataFrame(prediction5, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OnOnlyPred5Neg.csv')
pd.DataFrame(prediction6, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OnOnlyPred6Pos.csv')
...
np.save('ResultsSomiteEndoAll/fpr_kearstOnOnly.npy', fpr_keras)
np.save('ResultsSomiteEndoAll/fpr_kears1OnOnly.npy', fpr_keras1)
np.save('ResultsSomiteEndoAll/fpr_kears2OnOnly.npy', fpr_keras2)
np.save('ResultsSomiteEndoAll/fpr_kears4OnOnly.npy', fpr_kerast4)
np.save('ResultsSomiteEndoAll/fpr_kears5OnOnly.npy', fpr_keras5)
np.save('ResultsSomiteEndoAll/fpr_kears6OnOnly.npy', fpr_keras6)

np.save('ResultsSomiteEndoAll/tpr_kearstOnOnly.npy', tpr_keras)
np.save('ResultsSomiteEndoAll/tpr_kears1OnOnly.npy', tpr_keras1)
np.save('ResultsSomiteEndoAll/tpr_kears2OnOnly.npy', tpr_keras2)
np.save('ResultsSomiteEndoAll/tpr_kears4OnOnly.npy', tpr_kerast4)
np.save('ResultsSomiteEndoAll/tpr_kears5OnOnly.npy', tpr_keras5)
np.save('ResultsSomiteEndoAll/tpr_kears6OnOnly.npy', tpr_keras6)

np.save('ResultsSomiteEndoAll/pr_kearstOnOnly.npy', pr_keras)
np.save('ResultsSomiteEndoAll/pr_kears1OnOnly.npy', pr_keras1)
np.save('ResultsSomiteEndoAll/pr_kears2OnOnly.npy', pr_keras2)
np.save('ResultsSomiteEndoAll/pr_kears4OnOnly.npy', pr_kerast4)
np.save('ResultsSomiteEndoAll/pr_kears5OnOnly.npy', pr_keras5)
np.save('ResultsSomiteEndoAll/pr_kears6OnOnly.npy', pr_keras6)

np.save('ResultsSomiteEndoAll/re_kearstOnOnly.npy', re_keras)
np.save('ResultsSomiteEndoAll/re_kears1OnOnly.npy', re_keras1)
np.save('ResultsSomiteEndoAll/re_kears2OnOnly.npy', re_keras2)
np.save('ResultsSomiteEndoAll/re_kears4OnOnly.npy', re_kerast4)
np.save('ResultsSomiteEndoAll/re_kears5OnOnly.npy', re_keras5)
np.save('ResultsSomiteEndoAll/re_kears6OnOnly.npy', re_keras6)
...
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/CountsOnOnly.csv')
