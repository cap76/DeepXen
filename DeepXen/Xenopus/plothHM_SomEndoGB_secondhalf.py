...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoSomFullGB/SomEndo_OnTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoSomFullGB/SomEndo_OffTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoSomFullGB/SomEndo_OnOffT.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoSomChrGB/SomEndo_OnTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.xlim((-8,8))
plt.ylim((-1,140))
plt.savefig('EndoSomChrGB/SomEndo_OffTPFP_chronly.pdf')
plt.draw()
plt.close()
...
plt.savefig('EndoSomFullGB/PR.pdf')
plt.draw()
...
plt.title('Receiver operating characteristic')
plt.legend(loc="lower right")
plt.savefig('EndoSomFullGB/AUC.pdf')
plt.draw()
