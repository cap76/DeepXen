...
np.save('EndoFullSomEndo/UMAP1.npy', u1)


u1 = fit.fit_transform(C)
np.save('EndoFullSomEndo/UMAP2.npy', u2)


#u1 = fit.fit_transform(C)
#np.save('EndoFullSomEndo/UMAP3.npy', u2)


u1 = fit.fit_transform(A, n_neighbors = 200)
np.save('EndoFullSomEndo/UMAP1_2.npy', u1)


u1 = fit.fit_transform(C, n_neighbors = 200)
np.save('EndoFullSomEndo/UMAP2_2.npy', u2)
