...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAllGB/prediction_scores_seed=2.csv')

model.save('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAllGB/Model_seed=2.h5')
...
pd.DataFrame(XP, columns=fil).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAllGB/prediction_settozero_seed=2.csv')
...
pd.DataFrame(prediction, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/predictionGB.csv')
