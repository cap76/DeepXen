...
trainset=((Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-18]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-17]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-16]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-15]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-14]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-13]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-12]) & np.bitwise_or(Yalt[:,2]==1,Yalt[:,3]==1) )
valset=((Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-11]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-10]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-9]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-8]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-7]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-6]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-5]) & np.bitwise_or(Yalt[:,2]==1,Yalt[:,3]==1) )
testset=((Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-3]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-2]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-1]) | (Output2['f0']==meh.classes_[np.shape(meh.classes_)[0]-4]) & np.bitwise_or(Yalt[:,2]==1,Yalt[:,3]==1) )
...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/PredictionScores_OFFONLY.csv')
...
pd.DataFrame(prediction1, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OffOnlyPred1.csv')
pd.DataFrame(prediction2, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OffOnlyPred2Neg.csv')
pd.DataFrame(prediction3, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OffOnlyPred3Pos.csv')
pd.DataFrame(prediction4, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OffOnlyPred4.csv')
pd.DataFrame(prediction5, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OffOnlyPred5Neg.csv')
pd.DataFrame(prediction6, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/OffOnlyPred6Pos.csv')
...
np.save('ResultsSomiteEndoAll/fpr_kearstOffOnly.npy', fpr_keras)
np.save('ResultsSomiteEndoAll/fpr_kears1OffOnly.npy', fpr_keras1)
np.save('ResultsSomiteEndoAll/fpr_kears2OffOnly.npy', fpr_keras2)
np.save('ResultsSomiteEndoAll/fpr_kears4OffOnly.npy', fpr_kerast4)
np.save('ResultsSomiteEndoAll/fpr_kears5OffOnly.npy', fpr_keras5)
np.save('ResultsSomiteEndoAll/fpr_kears6OffOnly.npy', fpr_keras6)

np.save('ResultsSomiteEndoAll/tpr_kearstOffOnly.npy', tpr_keras)
np.save('ResultsSomiteEndoAll/tpr_kears1OffOnly.npy', tpr_keras1)
np.save('ResultsSomiteEndoAll/tpr_kears2OffOnly.npy', tpr_keras2)
np.save('ResultsSomiteEndoAll/tpr_kears4OffOnly.npy', tpr_kerast4)
np.save('ResultsSomiteEndoAll/tpr_kears5OffOnly.npy', tpr_keras5)
np.save('ResultsSomiteEndoAll/tpr_kears6OffOnly.npy', tpr_keras6)

np.save('ResultsSomiteEndoAll/pr_kearstOffOnly.npy', pr_keras)
np.save('ResultsSomiteEndoAll/pr_kears1OffOnly.npy', pr_keras1)
np.save('ResultsSomiteEndoAll/pr_kears2OffOnly.npy', pr_keras2)
np.save('ResultsSomiteEndoAll/pr_kears4OffOnly.npy', pr_kerast4)
np.save('ResultsSomiteEndoAll/pr_kears5OffOnly.npy', pr_keras5)
np.save('ResultsSomiteEndoAll/pr_kears6OffOnly.npy', pr_keras6)

np.save('ResultsSomiteEndoAll/re_kearstOffOnly.npy', re_keras)
np.save('ResultsSomiteEndoAll/re_kears1OffOnly.npy', re_keras1)
np.save('ResultsSomiteEndoAll/re_kears2OffOnly.npy', re_keras2)
np.save('ResultsSomiteEndoAll/re_kears4OffOnly.npy', re_kerast4)
np.save('ResultsSomiteEndoAll/re_kears5OffOnly.npy', re_keras5)
np.save('ResultsSomiteEndoAll/re_kears6OffOnly.npy', re_keras6)
...
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsSomiteEndoAll/CountsOffOnly.csv')
