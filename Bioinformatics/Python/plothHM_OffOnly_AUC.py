...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OFFONLYPredictionScores.csv')
...
pd.DataFrame(prediction1, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OffOnlyPred1.csv')
pd.DataFrame(prediction2, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OffOnlyPred2Neg.csv')
pd.DataFrame(prediction3, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OffOnlyPred3Pos.csv')
pd.DataFrame(prediction4, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OffOnlyPred4.csv')
pd.DataFrame(prediction5, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OffOnlyPred5Neg.csv')
pd.DataFrame(prediction6, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OffOnlyPred6Pos.csv')
...
np.save('EndoFull/fpr_kearstOffOnly.npy', fpr_keras)
np.save('EndoFull/fpr_kears1OffOnly.npy', fpr_keras1)
np.save('EndoFull/fpr_kears2OffOnly.npy', fpr_keras2)
np.save('EndoFull/fpr_kears4OffOnly.npy', fpr_kerast4)
np.save('EndoFull/fpr_kears5OffOnly.npy', fpr_keras5)
np.save('EndoFull/fpr_kears6OffOnly.npy', fpr_keras6)

np.save('EndoFull/tpr_kearstOffOnly.npy', tpr_keras)
np.save('EndoFull/tpr_kears1OffOnly.npy', tpr_keras1)
np.save('EndoFull/tpr_kears2OffOnly.npy', tpr_keras2)
np.save('EndoFull/tpr_kears4OffOnly.npy', tpr_kerast4)
np.save('EndoFull/tpr_kears5OffOnly.npy', tpr_keras5)
np.save('EndoFull/tpr_kears6OffOnly.npy', tpr_keras6)

np.save('EndoFull/pr_kearstOffOnly.npy', pr_keras)
np.save('EndoFull/pr_kears1OffOnly.npy', pr_keras1)
np.save('EndoFull/pr_kears2OffOnly.npy', pr_keras2)
np.save('EndoFull/pr_kears4OffOnly.npy', pr_kerast4)
np.save('EndoFull/pr_kears5OffOnly.npy', pr_keras5)
np.save('EndoFull/pr_kears6OffOnly.npy', pr_keras6)

np.save('EndoFull/re_kearstOffOnly.npy', re_keras)
np.save('EndoFull/re_kears1OffOnly.npy', re_keras1)
np.save('EndoFull/re_kears2OffOnly.npy', re_keras2)
np.save('EndoFull/re_kears4OffOnly.npy', re_kerast4)
np.save('EndoFull/re_kears5OffOnly.npy', re_keras5)
np.save('EndoFull/re_kears6OffOnly.npy', re_keras6)
...
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/CountsOffOnly.csv')
