...
pd.DataFrame(Scores, columns=['Accuracy']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/ONONLYPredictionScores.csv')
...
pd.DataFrame(prediction1, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OnOnlyPred1.csv')
pd.DataFrame(prediction2, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OnOnlyPred2Neg.csv')
pd.DataFrame(prediction3, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OnOnlyPred3Pos.csv')
pd.DataFrame(prediction4, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OnOnlyPred4.csv')
pd.DataFrame(prediction5, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OnOnlyPred5Neg.csv')
pd.DataFrame(prediction6, columns=['Chr','start','end','Gene','IVF','Donor','NT','FC','pVal','FC','pVal','ON','RepDown','Off','RepUp','Neg','pC1','pC2','pC3','pC4','pC5']).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/OnOnlyPred6Pos.csv')
...
xx1 = model.predict([Xchr[valset,:,:],Xexp[valset,:,:]], batch_size=1000)[:,[0,1]]
xx2 = model2.predict(Xchr[valset,:,:], batch_size=1000)[:,[0,1]]
xx3 = model3.predict(Xexp[valset,:,:], batch_size=1000)[:,[0,1]]
xx4 = model4.predict([Xchr[valset,:,:],Xexp[valset,:,:]], batch_size=1000)[:,[0,1]]
xx5 = model5.predict(Xchr[valset,:,:], batch_size=1000)[:,[0,1]]
xx6 = model6.predict(Xexp[valset,:,:], batch_size=1000)[:,[0,1]]

xx1_ = xx1[:,0] / (xx1[:,0]+xx1[:,1])
xx2_ = xx2[:,0] / (xx2[:,0]+xx2[:,1])
xx3_ = xx3[:,0] / (xx3[:,0]+xx3[:,1])
xx4_ = xx4[:,0] / (xx4[:,0]+xx4[:,1])
xx5_ = xx5[:,0] / (xx5[:,0]+xx5[:,1])
xx6_ = xx6[:,0] / (xx6[:,0]+xx6[:,1])

yy = Yalt[valset,0]

np.save('EndoFull/xx1.npy', xx1_)
np.save('EndoFull/xx2.npy', xx2_)
np.save('EndoFull/xx3.npy', xx3_)
np.save('EndoFull/xx4.npy', xx4_)
np.save('EndoFull/xx5.npy', xx5_)
np.save('EndoFull/xx6.npy', xx6_)
np.save('EndoFull/yy.npy', yy)


ac1 = accuracy_score(yy,xx1_.round())
ac2 = accuracy_score(yy,xx2_.round())
ac3 = accuracy_score(yy,xx3_.round())
ac4 = accuracy_score(yy,xx4_.round())
ac5 = accuracy_score(yy,xx5_.round())
ac6 = accuracy_score(yy,xx6_.round())

np.save('EndoFull/ac1.npy', ac1)
np.save('EndoFull/ac2.npy', ac2)
np.save('EndoFull/ac3.npy', ac3)
np.save('EndoFull/ac4.npy', ac4)
np.save('EndoFull/ac5.npy', ac5)
np.save('EndoFull/ac6.npy', ac6)


np.save('EndoFull/fpr_kearstOnOnly.npy', fpr_keras)
np.save('EndoFull/fpr_kears1OnOnly.npy', fpr_keras1)
np.save('EndoFull/fpr_kears2OnOnly.npy', fpr_keras2)
np.save('EndoFull/fpr_kears4OnOnly.npy', fpr_kerast4)
np.save('EndoFull/fpr_kears5OnOnly.npy', fpr_keras5)
np.save('EndoFull/fpr_kears6OnOnly.npy', fpr_keras6)

np.save('EndoFull/tpr_kearstOnOnly.npy', tpr_keras)
np.save('EndoFull/tpr_kears1OnOnly.npy', tpr_keras1)
np.save('EndoFull/tpr_kears2OnOnly.npy', tpr_keras2)
np.save('EndoFull/tpr_kears4OnOnly.npy', tpr_kerast4)
np.save('EndoFull/tpr_kears5OnOnly.npy', tpr_keras5)
np.save('EndoFull/tpr_kears6OnOnly.npy', tpr_keras6)

np.save('EndoFull/pr_kearstOnOnly.npy', pr_keras)
np.save('EndoFull/pr_kears1OnOnly.npy', pr_keras1)
np.save('EndoFull/pr_kears2OnOnly.npy', pr_keras2)
np.save('EndoFull/pr_kears4OnOnly.npy', pr_kerast4)
np.save('EndoFull/pr_kears5OnOnly.npy', pr_keras5)
np.save('EndoFull/pr_kears6OnOnly.npy', pr_keras6)

np.save('EndoFull/re_kearstOnOnly.npy', re_keras)
np.save('EndoFull/re_kears1OnOnly.npy', re_keras1)
np.save('EndoFull/re_kears2OnOnly.npy', re_keras2)
np.save('EndoFull/re_kears4OnOnly.npy', re_kerast4)
np.save('EndoFull/re_kears5OnOnly.npy', re_keras5)
np.save('EndoFull/re_kears6OnOnly.npy', re_keras6)
...
pd.DataFrame(M).to_csv('/mnt/scratch/gurdon/cap76/DeepXen/ResultsEndoAll/CountsOnOnly.csv')
