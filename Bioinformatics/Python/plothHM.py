...
for k in range(0, np.shape(fil)[0]):
      Xchr[:,0:100,k] = ( Xchr[:,0:100,k] - np.nanmean(Xchr[trainset,0:600,k]) ) / np.nanstd(Xchr[trainset,0:600,k])
...
np.save('EndoFull/hm1.npy', hm1)
np.save('EndoFull/hm2.npy', hm2)
np.save('EndoFull/hm3.npy', hm3)
np.save('EndoFull/hm4.npy', hm4)
np.save('EndoFull/hm5.npy', hm5)
np.save('EndoFull/hm6.npy', hm6)
np.save('EndoFull/hm7.npy', hm7)
np.save('EndoFull/hm8.npy', hm8)
np.save('EndoFull/hm9.npy', hm9)
np.save('EndoFull/hm10.npy', hm10)
np.save('EndoFull/hm11.npy', hm11)
np.save('EndoFull/hm12.npy', hm12)
np.save('EndoFull/hm13.npy', hm13)
np.save('EndoFull/hm14.npy', hm14)
np.save('EndoFull/hm15.npy', hm15)
np.save('EndoFull/hm16.npy', hm16)
np.save('EndoFull/hm17.npy', hm17)
np.save('EndoFull/hm18.npy', hm18)
np.save('EndoFull/hm19.npy', hm19)
np.save('EndoFull/hm20.npy', hm20)
np.save('EndoFull/hm21.npy', hm21)
np.save('EndoFull/hm22.npy', hm22)
np.save('EndoFull/hm23.npy', hm23)
np.save('EndoFull/hm24.npy', hm24)
...
plt.colorbar()
plt.savefig('EndoFull/OnTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.001,0.002)
plt.colorbar()
plt.savefig('EndoFull/ONTP_Deltac_cl1.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoFull/ONTP_Deltac_cl2.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoFull/ONTP_Deltac_cl3.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoFull/ONTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.001,0.002)
plt.colorbar()
plt.savefig('EndoFull/ONTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.001,0.002)
plt.colorbar()
plt.savefig('EndoFull/OffTP_Deltac.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoFull/OffTP_Deltac_cl1.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoFull/OffTP_Deltac_cl2.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoFull/OffTP_Deltac_cl3.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoFull/OffTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.001,0.002)
plt.colorbar()
plt.savefig('EndoFull/OffTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.002,0.01)
plt.colorbar()
plt.savefig('EndoFull/RUTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.002,0.01)
plt.colorbar()
plt.savefig('EndoFull/RUTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.002,0.01)
plt.colorbar()
plt.savefig('EndoFull/RUTP_Deltac_cl2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
plt.clim(-0.002,0.01)
plt.colorbar()
plt.savefig('EndoFull/RUTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.002,0.01)
plt.colorbar()
plt.savefig('EndoFull/RUTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.002,0.01)
plt.colorbar()
plt.savefig('EndoFull/RUTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.001,0.01)
plt.colorbar()
plt.savefig('EndoFull/RDTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.001,0.01)
plt.colorbar()
plt.savefig('EndoFull/RDTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.001,0.01)
plt.colorbar()
plt.savefig('EndoFull/RDTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.001,0.01)
plt.colorbar()
plt.savefig('EndoFull/RDTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.001,0.01)
plt.colorbar()
plt.savefig('EndoFull/RDTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.001,0.01)
plt.colorbar()
plt.savefig('EndoFull/RDTP_Deltac_cl5.pdf')
plt.close()

np.save('EndoFull/hm1_delta.npy', hm1)
np.save('EndoFull/hm2_delta.npy', hm2)
np.save('EndoFull/hm3_delta.npy', hm3)
np.save('EndoFull/hm4_delta.npy', hm4)
np.save('EndoFull/hm5_delta.npy', hm5)
np.save('EndoFull/hm6_delta.npy', hm6)
np.save('EndoFull/hm7_delta.npy', hm7)
np.save('EndoFull/hm8_delta.npy', hm8)
np.save('EndoFull/hm9_delta.npy', hm9)
np.save('EndoFull/hm10_delta.npy', hm10)
np.save('EndoFull/hm11_delta.npy', hm11)
np.save('EndoFull/hm12_delta.npy', hm12)
np.save('EndoFull/hm13_delta.npy', hm13)
np.save('EndoFull/hm14_delta.npy', hm14)
np.save('EndoFull/hm15_delta.npy', hm15)
np.save('EndoFull/hm16_delta.npy', hm16)
np.save('EndoFull/hm17_delta.npy', hm17)
np.save('EndoFull/hm18_delta.npy', hm18)
np.save('EndoFull/hm19_delta.npy', hm19)
np.save('EndoFull/hm20_delta.npy', hm20)
np.save('EndoFull/hm21_delta.npy', hm21)
np.save('EndoFull/hm22_delta.npy', hm22)
np.save('EndoFull/hm23_delta.npy', hm23)
np.save('EndoFull/hm24_delta.npy', hm24)
...
plt.colorbar()
plt.savefig('EndoChr/OnTP_ac.pdf')
plt.close()
...
plt.clim(-0.001,0.005)
plt.colorbar()
plt.savefig('EndoChr/ONTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.001,0.005)
plt.colorbar()
plt.savefig('EndoChr/ONTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.001,0.005)
plt.colorbar()
plt.savefig('EndoChr/ONTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.001,0.005)
plt.colorbar()
plt.savefig('EndoChr/ONTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.001,0.005)
plt.colorbar()
plt.savefig('EndoChr/ONTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.001,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_ac.pdf')
plt.close()
...
plt.clim(-0.001,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.001,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.001,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.001,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.001,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_ac_cl5.pdf')
plt.close()
...
plt.clim(-0.0,0.004)
plt.colorbar()
plt.savefig('EndoChr/RUTP_ac.pdf')
plt.close()
...
plt.clim(-0.0,0.004)
plt.colorbar()
plt.savefig('EndoChr/RUTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.0,0.004)
plt.colorbar()
plt.savefig('EndoChr/RUTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.0,0.004)
plt.colorbar()
plt.savefig('EndoChr/RUTP_ac_cl3.pdf')
plt.close()
...
plt.clim(-0.0,0.004)
plt.colorbar()
plt.savefig('EndoChr/RUTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.0,0.004)
plt.colorbar()
plt.savefig('EndoChr/RUTP_ac_cl5.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoChr/RDTP_ac.pdf')
plt.close()
...
plt.clim(-0.0006,0.001)
plt.colorbar()
plt.savefig('EndoChr/RDTP_ac_cl1.pdf')
plt.close()
...
plt.clim(-0.0006,0.001)
plt.colorbar()
plt.savefig('EndoChr/RDTP_ac_cl2.pdf')
plt.close()
...
plt.clim(-0.0006,0.001)
plt.colorbar()
plt.savefig('EndoChr/RDTP_ac_cl3.pdf')
plt.close()
...
#plt.clim(-0.003,0.001)
plt.colorbar()
plt.savefig('EndoChr/RDTP_ac_cl4.pdf')
plt.close()
...
plt.clim(-0.0006,0.001)
plt.colorbar()
plt.savefig('EndoChr/RDTP_ac_cl5.pdf')
plt.close()

np.save('EndoChr/hm1.npy', hm1)
np.save('EndoChr/hm2.npy', hm2)
np.save('EndoChr/hm3.npy', hm3)
np.save('EndoChr/hm4.npy', hm4)
np.save('EndoChr/hm5.npy', hm4)
np.save('EndoChr/hm6.npy', hm6)
np.save('EndoChr/hm7.npy', hm7)
np.save('EndoChr/hm8.npy', hm8)
np.save('EndoChr/hm9.npy', hm9)
np.save('EndoChr/hm10.npy', hm10)
np.save('EndoChr/hm11.npy', hm11)
np.save('EndoChr/hm12.npy', hm12)
np.save('EndoChr/hm13.npy', hm13)
np.save('EndoChr/hm14.npy', hm14)
np.save('EndoChr/hm15.npy', hm15)
np.save('EndoChr/hm16.npy', hm16)
np.save('EndoChr/hm17.npy', hm17)
np.save('EndoChr/hm18.npy', hm18)
np.save('EndoChr/hm19.npy', hm19)
np.save('EndoChr/hm20.npy', hm20)
np.save('EndoChr/hm21.npy', hm21)
np.save('EndoChr/hm22.npy', hm22)
np.save('EndoChr/hm23.npy', hm23)
np.save('EndoChr/hm24.npy', hm24)
...
plt.clim(-0.0,0.001)
plt.colorbar()
plt.savefig('EndoChr/OnTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.0,0.001)
plt.colorbar()
plt.savefig('EndoChr/ONTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.0,0.001)
plt.colorbar()
plt.savefig('EndoChr/ONTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.0,0.001)
plt.colorbar()
plt.savefig('EndoChr/ONTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.0,0.001)
plt.colorbar()
plt.savefig('EndoChr/ONTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.0,0.001)
plt.colorbar()
plt.savefig('EndoChr/ONTP_Deltac_cl5.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoChr/OffTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/OffTP_Deltac_cl5.pdf')
plt.close()
...
plt.colorbar()
plt.savefig('EndoChr/RUTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.002,0.002)
plt.colorbar()
plt.savefig('EndoChr/RUTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.002,0.002)
plt.colorbar()
plt.savefig('EndoChr/RUTP_Deltac_cl2.pdf')
plt.figure()
plt.subplot(1, 1, 1)
plt.imshow(np.transpose(hm16), interpolation='nearest', aspect='auto')
plt.yticks(np.arange(22), labs, fontsize=6,  rotation=20)
...
plt.clim(-0.002,0.002)
plt.colorbar()
plt.savefig('EndoChr/RUTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.002,0.002)
plt.colorbar()
plt.savefig('EndoChr/RUTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.002,0.002)
plt.colorbar()
plt.savefig('EndoChr/RUTP_Deltac_cl5.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/RDTP_Deltac.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/RDTP_Deltac_cl1.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/RDTP_Deltac_cl2.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/RDTP_Deltac_cl3.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/RDTP_Deltac_cl4.pdf')
plt.close()
...
plt.clim(-0.002,0.003)
plt.colorbar()
plt.savefig('EndoChr/RDTP_Deltac_cl5.pdf')
plt.close()
...
np.save('EndoChr/hm1_delta.npy', hm1)
np.save('EndoChr/hm2_delta.npy', hm2)
np.save('EndoChr/hm3_delta.npy', hm3)
np.save('EndoChr/hm4_delta.npy', hm4)
np.save('EndoChr/hm5_delta.npy', hm4)
np.save('EndoChr/hm6_delta.npy', hm6)
np.save('EndoChr/hm7_delta.npy', hm7)
np.save('EndoChr/hm8_delta.npy', hm8)
np.save('EndoChr/hm9_delta.npy', hm9)
np.save('EndoChr/hm10_delta.npy', hm10)
np.save('EndoChr/hm11_delta.npy', hm11)
np.save('EndoChr/hm12_delta.npy', hm12)
np.save('EndoChr/hm13_delta.npy', hm13)
np.save('EndoChr/hm14_delta.npy', hm14)
np.save('EndoChr/hm15_delta.npy', hm15)
np.save('EndoChr/hm16_delta.npy', hm16)
np.save('EndoChr/hm17_delta.npy', hm17)
np.save('EndoChr/hm18_delta.npy', hm18)
np.save('EndoChr/hm19_delta.npy', hm19)
np.save('EndoChr/hm20_delta.npy', hm20)
np.save('EndoChr/hm21_delta.npy', hm21)
np.save('EndoChr/hm22_delta.npy', hm22)
np.save('EndoChr/hm23_delta.npy', hm23)
np.save('EndoChr/hm24_delta.npy', hm24)
