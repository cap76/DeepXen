...
pheatmap(t(pVal1),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_default_pvaluevsmemory_4cl.pdf")
pheatmap(t(pVal2),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_default_pvaluevsshuffle_4cl.pdf")
...
rownames(pVal2) <- c(paste("Cl",rep(1:NCl, each=1)) )
mat_breaks <- seq(0, 0.05, length.out = 20)
pheatmap(t(pVal1),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_default_pvaluevsmemory_4cl.pdf")
pheatmap(t(pVal2),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_default_pvaluevsshuffle_4cl.pdf")
...
rownames(pVal2) <- c(paste("Cl",rep(1:NCl, each=1)) )
mat_breaks <- seq(0, 0.05, length.out = 20)
pheatmap(t(pVal1),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_default_pvaluevsmemory_4cl.pdf")
pheatmap(t(pVal2),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_default_pvaluevsshuffle_4cl.pdf")
...
rownames(pVal2) <- c(paste("Cl",rep(1:NCl, each=1)) )
mat_breaks <- seq(0, 0.05, length.out = 20)
pheatmap(t(pVal1),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_default_pvaluevsmemory_4cl.pdf")
pheatmap(t(pVal2),color =  redblue1(20), breaks=mat_breaks, border_color = NA, cluster_rows=FALSE, cluster_cols=FALSE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_default_pvaluevsshuffle_4cl.pdf")
...
#Load activtion data in this case the RD activations for the TP ON memory genes
labs<-c("Ecto_H2A.ub","Ecto_H2A.x.3","Ecto_H3K27ac","Ecto_H3K27me3","Ecto_H3K36me3","Ecto_H3K4me1","Ecto_H3K4me2","Ecto_H3K4me3","Ecto_H3K79me3","Ecto_H3K9me3","Endo_H2A.ub","Endo_H2A.x.3","Endo_H3K27ac","Endo_H3K27me3","Endo_H3K36me3","Endo_H3K4me1","Endo_H3K4me2","Endo_H3K4me3","Endo_H3K79me3","Endo_H3K9me3","GC.bw.tab","Methylation")
labs2<-c("H2A.ub","H2A.x.3","H3K27ac","H3K27me3","H3K36me3","H3K4me1","H3K4me2","H3K4me3","H3K79me3","H3K9me3")
...
mean1 = apply(mat1-mat, c(1,3), sum) / dim(mat1)[2]
mean2 = apply(mat1-mat, c(2,3), sum) / dim(mat1)[1]
mean3 = apply(mat1[,,11:20]-mat1[,,0:10], c(1,3), sum) / dim(mat1)[2]
#"#f0f9ff","#f7f0f0"
redblue1 <- colorRampPalette(c("#00B0F0",
                               "#DFF5FD",
                               "#FFFFFF",
...
clusters <- kmeans(mean1, NCl)
SummaryMat1 <- array(0,c(NCl,dim(mat)[3]))
SummaryMat2 <- array(0,c(NCl,10))
uniqueMat1 <- array(0,c(NCl,dim(mat)[2],dim(mat)[3]))
uniqueMat2 <- array(0,c(10,dim(mat)[2],dim(mat)[3]))
for (i in 1:NCl)  {
  ind <- which(clusters$cluster==i)
  uniqueMat1[i,,] <- apply(mat1[ind,,]-mat[ind,,], c(2,3), sum) / length(ind)
  SummaryMat1[i,] <- 600*colSums(mean1[ind,])/length(ind)
  
  #uniqueMat2[i,,] <- apply(mat1[ind,,11:20]-mat1[ind,,0:10], c(2,3), sum) / length(ind)
  SummaryMat2[i,] <- 600*colSums(mean3[ind,])/length(ind)
  
}
colnames(SummaryMat1) <- labs
rownames(SummaryMat1) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat1), color =  redblue1(20),  gaps_row=c(10,20), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_delta_defaultscale_redo.pdf")
colnames(SummaryMat2) <- labs2[0:10]
rownames(SummaryMat2) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat2), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_delta_defaultscale_targetsissu_minus_donor.pdf")
mat_breaks <- seq(-0.01, 0.01, length.out = 20)
pheatmap(t(SummaryMat2), breaks=mat_breaks, color =  redblue1(10),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_delta_defaultscale_targetsissu_minus_donor_op1.pdf")

SummaryMat3 <- SummaryMat1[,11:20]-SummaryMat1[,0:10]
colnames(SummaryMat3) <- labs2[0:10]
rownames(SummaryMat3) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat3), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_delta_delta_defaultscale_targetsissue_minus_donor.pdf")

mat_breaks <- seq(-0.2, 0.2, length.out = 20)
pheatmap(t(SummaryMat3), breaks = mat_breaks,color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_delta_delta_0p2_defaultscale_targetsissue_minus_donor.pdf")
mat_breaks <- seq(-0.1, 0.1, length.out = 20)
pheatmap(t(SummaryMat3), breaks = mat_breaks,color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/OFFRUPCl_delta_delta_0p1_defaultscale_targetsissue_minus_donor.pdf")
...
colnames(SummaryMat1) <- labs
rownames(SummaryMat1) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat1), color =  redblue1(20),  gaps_row=c(10,20), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_delta_defaultscale_redo.pdf")
colnames(SummaryMat2) <- labs2[0:10]
rownames(SummaryMat2) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat2), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_delta_defaultscale_targetsissu_minus_donor.pdf")
mat_breaks <- seq(-0.1, 0.1, length.out = 20)
pheatmap(t(SummaryMat2), color =  redblue1(20), breaks=mat_breaks,  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_delta_defaultscale_targetsissu_minus_donor_op1.pdf")


SummaryMat3 <- SummaryMat1[,11:20]-SummaryMat1[,0:10]
colnames(SummaryMat3) <- labs2[0:10]
rownames(SummaryMat3) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat3), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_delta_delta_defaultscale_targetsissue_minus_donor.pdf")

mat_breaks <- seq(-0.1, 0.1, length.out = 20)
pheatmap(t(SummaryMat3), color =  redblue1(20),   breaks=mat_breaks, gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_delta_delta_defaultscale_0p1_targetsissue_minus_donor.pdf")


mat_breaks <- seq(-0.2, 0.2, length.out = 20)
pheatmap(t(SummaryMat3), color =  redblue1(20),   breaks=mat_breaks, gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/ONRDPCl_delta_delta_defaultscale_0p2_targetsissue_minus_donor.pdf")
...
mean1 = apply(mat1-mat, c(1,3), sum) / dim(mat1)[2]
mean2 = apply(mat1-mat, c(2,3), sum) / dim(mat1)[1]
mean3 = apply(mat1[,,0:10]-mat1[,,11:20], c(1,3), sum) / dim(mat1)[2]
#"#f0f9ff","#f7f0f0"
redblue1 <- colorRampPalette(c("#00B0F0",
                               "#DFF5FD",
                               "#FFFFFF",
...
colnames(SummaryMat1) <- labs
rownames(SummaryMat1) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat1), color =  redblue1(20),  gaps_row=c(10,20), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_delta_defaultscale_redo.pdf")
colnames(SummaryMat2) <- labs2[0:10]
rownames(SummaryMat2) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat2), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_delta_defaultscale_targetsissu_minus_donor.pdf")
mat_breaks <- seq(-0.1, 0.1, length.out = 20)
pheatmap(t(SummaryMat2), color =  redblue1(20), breaks = mat_breaks, gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_delta_defaultscale_targetsissu_minus_donor_op1.pdf")


SummaryMat3 <- SummaryMat1[,0:10]-SummaryMat1[,11:20]
colnames(SummaryMat3) <- labs2[0:10]
rownames(SummaryMat3) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat3), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_delta_delta_defaultscale_targetsissue_minus_donor.pdf")
mat_breaks <- seq(-0.1, 0.1, length.out = 20)
pheatmap(t(SummaryMat3), color =  redblue1(20),   breaks = mat_breaks, gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_delta_delta_defaultscale_0p1_targetsissue_minus_donor.pdf")
mat_breaks <- seq(-0.2, 0.2, length.out = 20)
pheatmap(t(SummaryMat3), color =  redblue1(20),   breaks = mat_breaks, gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_OFFRUPCl_delta_delta_defaultscale_0p2_targetsissue_minus_donor.pdf")
...
colnames(SummaryMat1) <- labs
rownames(SummaryMat1) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat1), color =  redblue1(20),  gaps_row=c(10,20), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_delta_defaultscale_redo.pdf")
colnames(SummaryMat2) <- labs2[0:10]
rownames(SummaryMat2) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat2), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_delta_defaultscale_targetsissu_minus_donor.pdf")
mat_breaks <- seq(-0.1, 0.1, length.out = 20)
pheatmap(t(SummaryMat2), breaks = mat_breaks, color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_delta_defaultscale_targetsissu_minus_donor_op1.pdf")


SummaryMat3 <- SummaryMat1[,0:10]-SummaryMat1[,11:20]
colnames(SummaryMat3) <- labs2[0:10]
rownames(SummaryMat3) <- c(paste("Cl",rep(1:NCl, each=1)) )
pheatmap(t(SummaryMat3), color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_delta_delta_defaultscale_targetsissue_minus_donor.pdf")
mat_breaks <- seq(-0.1, 0.1, length.out = 20)
pheatmap(t(SummaryMat3), breaks = mat_breaks, color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_delta_delta_defaultscale_0p1_targetsissue_minus_donor.pdf")

mat_breaks <- seq(-0.2, 0.2, length.out = 20)
pheatmap(t(SummaryMat3), breaks = mat_breaks, color =  redblue1(20),  gaps_row=c(10), border_color = NA, cluster_rows=FALSE, cluster_cols=TRUE, main = c("Cluster summary"),filename = "~/Desktop/SomEndo_ONRDPCl_delta_delta_defaultscale_0p2_targetsissue_minus_donor.pdf")
